...
- NHibernate contract coverage shared across providers (native SQL params, mapped entity lifecycle, transaction rollback, pagination, HQL/Criteria, and null/typed parameters in both INSERT and WHERE filters)
...
- Cobertura de contrato NHibernate compartilhada entre provedores (parâmetros em SQL nativo, ciclo de vida de entidade mapeada, rollback transacional, paginação, HQL/Criteria e parâmetros nulos/tipados em INSERT e filtros WHERE)
