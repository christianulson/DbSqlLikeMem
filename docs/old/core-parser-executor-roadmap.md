...
| 4) Tipos/literais/coerção | **55%** | ⬆️ | Base central em `SqlExtensions` evoluiu com hardening de coerção booleana/textual e comparação numérica implícita por política de dialeto; ainda faltam regras finas por dialeto/versão. |
