...
Prompts prontos para colar em outras janelas e implementar as próximas features de maior uso no DbSqlLikeMem, cobrindo **MySQL, MariaDB, Firebird, SQL Server, SQL Azure, PostgreSQL (Npgsql), SQLite e DB2**.
...
Objetivo:
Validar e alinhar documentação, matriz de compatibilidade e versões simuladas para TODOS os providers: MySQL, MariaDB, Firebird, SQL Server, SQL Azure, Oracle, PostgreSQL (Npgsql), SQLite e DB2.
...
Critérios de aceite:
- Cenários SQL Core verdes nos 9 providers.
...
Referência de testes:
- *SqlCompatibilityGapTests.cs de MySQL, MariaDB, Firebird, SQL Server, SQL Azure, PostgreSQL (Npgsql), SQLite e DB2.
...
Critérios de aceite:
- Cenários de mutação mais comuns suportados nos 9 providers.
