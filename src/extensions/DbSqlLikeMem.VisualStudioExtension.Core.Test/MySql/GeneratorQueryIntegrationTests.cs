...
/// PT: Verifica as queries do generator contra um banco de benchmark MySQL real.
/// </summary>
/// <param name="helper">
...
public sealed class GeneratorQueryIntegrationTests(ITestOutputHelper helper) : XUnitTestBase(helper)
{
    ...
    /// PT: Verifica se o provedor de metadados lista e le objetos de benchmark criados em um banco MySQL real.
    /// </summary>
    [Fact]
