...
namespace DbSqlLikeMem.VisualStudioExtension.Core.Test.MySql;

/// <summary>
/// EN: Verifies generator queries against a real MySQL benchmark database.
/// PT-br: Verifica as queries do generator contra um banco de benchmark MySQL real.
/// </summary>
/// <param name="helper">
...
{
    /// <summary>
    /// EN: Verifies the metadata provider lists and reads benchmark objects created in a real MySQL database.
    /// PT-br: Verifica se o provedor de metadados lista e le objetos de benchmark criados em um banco MySQL real.
    /// </summary>
    [Fact]
