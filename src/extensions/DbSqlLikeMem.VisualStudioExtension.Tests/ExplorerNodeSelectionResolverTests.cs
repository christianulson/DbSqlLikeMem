...
/// PT-br: Verifica as regras de promocao de no do explorador usadas pelo menu de contexto da janela de ferramentas do Visual Studio.
/// </summary>
public sealed class ExplorerNodeSelectionResolverTests
{
    ...
    /// PT-br: Garante que nos de objeto permaneçam selecionados como estao quando ja representam o contexto efetivo.
    /// </summary>
    [Fact]
    ...
    /// PT-br: Garante que grupos de detalhe de tabela sejam promovidos para o no de objeto proprietario.
    /// </summary>
    [Fact]
    [Trait("Category", "VisualStudioSelectionResolver")]
    ...
    /// PT-br: Garante que itens de detalhe de tabela tambem sejam promovidos para o no de objeto proprietario.
    /// </summary>
    [Fact]
    [Trait("Category", "VisualStudioSelectionResolver")]
    ...
    /// PT-br: Garante que nos de detalhe sem objeto proprietario nao produzam um contexto falso.
    /// </summary>
    [Fact]
    [Trait("Category", "VisualStudioSelectionResolver")]
