...
/// PT: Descreve a selecao efetiva do explorador usada para calcular o estado do menu de contexto.
/// </summary>
public sealed class ExplorerContextMenuSelection
{
    /// <summary>
    /// EN: Creates a selection snapshot for the explorer context menu rules.
    /// PT: Cria um snapshot de selecao para as regras do menu de contexto do explorador.
    /// </summary>
    ...
    /// PT: Obtem se a extracao de scenario deve ficar disponivel para a selecao atual.
    /// </summary>
    ...
    /// PT: Obtem se o filtro de tipo de objeto pode ser limpo para a selecao atual.
    /// </summary>
...
/// PT: Descreve o estado de visibilidade dos comandos do menu de contexto do explorador.
/// </summary>
public sealed class ExplorerContextMenuState
{
    /// <summary>
    /// EN: Creates a visibility state for the explorer context menu commands.
    /// PT: Cria um estado de visibilidade para os comandos do menu de contexto do explorador.
    /// </summary>
...
/// PT: Calcula a visibilidade do menu de contexto do explorador a partir do estado atual da selecao.
/// </summary>
public static class ExplorerContextMenuStateCalculator
{
    /// <summary>
    /// EN: Builds the visibility state for the explorer context menu.
    /// PT: Monta o estado de visibilidade para o menu de contexto do explorador.
    /// </summary>
