...
/// PT: Fornece rótulos plurais canônicos para tipos de objeto de banco usados pela UI e pelos construtores de árvore.
/// </summary>
public static class DatabaseObjectTypeLabels
{
    /// <summary>
    /// EN: Returns the plural label used for the informed database object type.
    /// PT: Retorna o rótulo plural usado para o tipo de objeto de banco informado.
    /// </summary>
