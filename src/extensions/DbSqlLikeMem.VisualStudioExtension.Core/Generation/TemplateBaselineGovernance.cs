...
/// PT-br: Valida se o catalogo compartilhado de baseline permanece alinhado aos metadados versionados de revisao.
/// </summary>
public static class TemplateBaselineGovernance
{
    ...
    /// PT-br: Retorna avisos de governanca para o perfil informado quando os metadados de revisao divergem das expectativas do catalogo.
    /// </summary>
    /// <param name="profile">EN: Baseline profile that should be validated. PT-br: Perfil de baseline que deve ser validado.</param>
    /// <param name="reviewMetadata">EN: Review metadata loaded from `review-metadata.json`. PT-br: Metadados de revisao carregados de `review-metadata.json`.</param>
