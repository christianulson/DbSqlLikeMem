...
/// PT-br: Formata metadados de baseline versionada de templates para dialogos voltados ao usuario sem duplicar regras do catalogo na UI.
/// </summary>
public static class TemplateBaselinePresentation
{
    ...
    /// PT-br: Monta um resumo para fluxos de configuracao de templates a partir do perfil de baseline informado.
    /// </summary>
    /// <param name="profile">EN: Baseline profile selected by the user. PT-br: Perfil de baseline selecionado pelo usuario.</param>
    /// <param name="reviewMetadata">EN: Optional review metadata loaded from `review-metadata.json`. PT-br: Metadados opcionais de revisao carregados de `review-metadata.json`.</param>
    /// <param name="todayUtc">EN: Optional UTC date used to evaluate review windows deterministically. PT-br: Data UTC opcional usada para avaliar janelas de revisao de forma deterministica.</param>
    ...
    /// PT-br: Monta um resumo para fluxos de configuracao de mapeamento usando a recomendacao do perfil e do tipo de objeto selecionados.
    /// </summary>
    /// <param name="profile">EN: Baseline profile selected by the user. PT-br: Perfil de baseline selecionado pelo usuario.</param>
    /// <param name="objectType">EN: Object type currently being configured. PT-br: Tipo de objeto configurado no momento.</param>
    /// <param name="reviewMetadata">EN: Optional review metadata loaded from `review-metadata.json`. PT-br: Metadados opcionais de revisao carregados de `review-metadata.json`.</param>
    /// <param name="todayUtc">EN: Optional UTC date used to evaluate review windows deterministically. PT-br: Data UTC opcional usada para avaliar janelas de revisao de forma deterministica.</param>
