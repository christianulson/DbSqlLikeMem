...
/// PT-br: Representa os metadados versionados de revisao associados a baseline compartilhada de templates.
/// </summary>
public sealed record TemplateReviewMetadata
{
    /// <summary>
    /// EN: Creates a versioned template review metadata snapshot.
    /// PT-br: Cria um snapshot versionado dos metadados de revisao de templates.
    /// </summary>
    /// <param name="currentBaseline">EN: Current promoted baseline identifier. PT-br: Identificador da baseline promovida atual.</param>
    /// <param name="promotionStagingPath">EN: Repository-relative staging path used for the next promotion. PT-br: Caminho relativo no repositorio usado como staging da proxima promocao.</param>
    /// <param name="reviewCadence">EN: Expected review cadence label. PT-br: Rotulo da cadencia esperada de revisao.</param>
    /// <param name="lastReviewedOn">EN: Last completed review date in ISO format. PT-br: Data da ultima revisao concluida em formato ISO.</param>
    ...
    /// <param name="profileFocusById">EN: Recommended focus indexed by baseline profile id. PT-br: Foco recomendado indexado pelo id do perfil de baseline.</param>
    /// <param name="evidenceFiles">EN: Repository-relative evidence files that support the review. PT-br: Arquivos de evidencia relativos ao repositorio que sustentam a revisao.</param>
    ...
    /// PT-br: Obtem o texto de foco recomendado indexado por id do perfil.
    /// </summary>
    ...
    /// PT-br: Obtem os arquivos de evidencia relativos ao repositorio associados a revisao.
    /// </summary>
