...
#pragma warning restore CA1859 // Use concrete types when possible for improved performance
    ...
    {
        var collector = new Db2TranslationParameterCollector();
...
#pragma warning restore CS8605 // Unboxing a possibly null value.
            ...
            case ConstantExpression constant:
                {
                    ...
                    if (valueType.IsGenericType && valueType.GetGenericTypeDefinition() == typeof(Db2Queryable<>))
                    {
                        var property = valueType.GetProperty(nameof(Db2Queryable<object>.TableName), BindingFlags.Instance | BindingFlags.Public);
    ...
    private sealed class Db2TranslationParameterCollector : ExpressionVisitor
    {
