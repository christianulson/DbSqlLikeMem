...
/// PT: Cobre cenarios extras de SELECT e WHERE SQL Server sobre uma conexao mock direta.
/// </summary>
public sealed class SqlServerSelectAndWhereMoreCoverageTests : XUnitTestBase
{
    ...
    /// PT: Cria o banco SQL Server em memoria usado pelos testes extras de cobertura de SELECT e WHERE.
    /// </summary>
...
ORDER BY id").ToList();
    ...
    /// PT: Verifica se projeções no estilo ISNULL ou COALESCE retornam o valor de fallback esperado.
    /// </summary>
    [Fact]
    [Trait("Category", "SqlServerSelectAndWhereMoreCoverage")]
