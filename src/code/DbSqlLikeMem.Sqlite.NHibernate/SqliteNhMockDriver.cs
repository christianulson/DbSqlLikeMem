namespace DbSqlLikeMem.Sqlite.NHibernate;

/// <summary>
/// EN: NHibernate driver bound to DbSqlLikeMem Sqlite mock ADO.NET types.
/// PT-br: Driver NHibernate ligado aos tipos ADO.NET simulado Sqlite do DbSqlLikeMem.
/// </summary>
public sealed class SqliteNhMockDriver : ReflectionBasedDriver
{
    ...
    /// PT-br: Inicializa um driver simulado do NHibernate para os tipos do provedor Sqlite do DbSqlLikeMem.
    /// </summary>
