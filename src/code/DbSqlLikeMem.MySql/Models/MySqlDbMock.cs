...
/// PT-br: Banco de dados simulado em memória configurado para MySQL.
/// </summary>
    ...
    : DbMock
{
    ...
    /// PT-br: Inicializa um banco MySQL simulado em memória com a versão informada e os modos opcionais de parsing ANSI_QUOTES e PIPES_AS_CONCAT.
    /// </summary>
    ...
    /// PT-br: Inicializa um banco simulado em memória da família MySQL com uma factory de dialeto customizada.
    /// </summary>
    /// <param name="version">EN: Optional simulated version. PT-br: Versão simulada opcional.</param>
    ...
    /// PT-br: Cria uma instância de simulado de schema MySQL.
    /// </summary>
