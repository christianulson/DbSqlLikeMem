...
/// PT-br: Implementação de dialeto SQL para a família MySQL suportada por este provedor.
/// </summary>
internal partial class MySqlDialect : SqlDialectBase
{
    ...
    /// PT-br: Inicializa o dialeto MySQL para a versão simulada informada e modos opcionais de parser.
    /// </summary>
    /// <param name="version">EN: Simulated MySQL version. PT-br: Versão simulada do MySQL.</param>
    /// <param name="ansiQuotes">EN: Enables ANSI_QUOTES mode so double quotes are parsed as identifiers. PT-br: Habilita o modo ANSI_QUOTES para que aspas duplas sejam interpretadas como identificadores.</param>
    /// <param name="pipesAsConcat">EN: Enables PIPES_AS_CONCAT mode so || is parsed as string concatenation. PT-br: Habilita o modo PIPES_AS_CONCAT para que || seja interpretado como concatenacao de strings.</param>
    ...
    /// PT-br: Inicializa um dialeto da família MySQL com nome de provedor, versão e modos opcionais de parser customizados.
    /// </summary>
    /// <param name="dialectName">EN: Dialect/provider name exposed to the parser and executor. PT-br: Nome do dialeto/provedor exposto ao parser e executor.</param>
    /// <param name="version">EN: Simulated dialect version. PT-br: Versão simulada do dialeto.</param>
    /// <param name="ansiQuotes">EN: Enables ANSI_QUOTES mode so double quotes are parsed as identifiers. PT-br: Habilita o modo ANSI_QUOTES para que aspas duplas sejam interpretadas como identificadores.</param>
    /// <param name="pipesAsConcat">EN: Enables PIPES_AS_CONCAT mode so || is parsed as string concatenation. PT-br: Habilita o modo PIPES_AS_CONCAT para que || seja interpretado como concatenacao de strings.</param>
    ...
    /// PT-br: Obtém ou define AllowsBacktickIdentifiers.
    /// </summary>
    public override bool AllowsBacktickIdentifiers => true;
    /// <summary>
    /// EN: Gets or sets AllowsDoubleQuoteIdentifiers.
    /// PT-br: Obtém ou define AllowsDoubleQuoteIdentifiers.
    /// </summary>
    ...
    /// PT-br: Obtém ou define IdentifierEscapeStyle.
    /// </summary>
    ...
    /// PT-br: Usa comparações textuais case-insensitive no executor em memória para testes determinísticos.
    /// </summary>
    ...
    /// PT-br: Habilita comparação implícita numérica/string apenas quando ambos os valores são conversíveis para número.
    /// </summary>
    ...
    /// PT-br: Mantém LIKE case-insensitive por padrão no provedor simulado.
    /// </summary>
    ...
    /// PT-br: Obtém ou define SupportsHashLineComment.
    /// </summary>
    ...
    /// PT-br: Obtém ou define SupportsWithCte.
    /// </summary>
    ...
    /// PT-br: Indica se a sintaxe de CTE recursiva é suportada pela versão configurada do MySQL.
    /// </summary>
    ...
    /// PT-br: Indica se funções de janela SQL são suportadas pela versão configurada do MySQL.
    /// </summary>
    ...
    /// PT-br: Indica se a concatenação de strings retorna <c>NULL</c> quando qualquer operando é <c>NULL</c>.
    /// </summary>
    public override bool ConcatReturnsNullOnNullInput => true;
    /// <summary>
    /// EN: Gets or sets SupportsJsonArrowOperators.
    /// PT-br: Obtém ou define SupportsJsonArrowOperators.
    /// </summary>
    ...
    /// PT-br: Indica se operadores JSON entre dialetos são aceitos pelo parser para compatibilidade.
    /// </summary>
    ...
    /// PT-br: Indica se hints de índice do MySQL são suportados na geração de SQL.
    /// </summary>
