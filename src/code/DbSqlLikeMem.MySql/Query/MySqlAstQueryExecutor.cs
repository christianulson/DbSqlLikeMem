...
/// PT-br: Registra o executor AST de MySQL na factory compartilhada.
/// </summary>
public static class MySqlAstQueryExecutorRegister
{
    /// <summary>
    /// EN: Registers the MySQL AST executor for the default MySQL dialect.
    /// PT-br: Registra o executor AST de MySQL para o dialeto MySQL padrao.
    /// </summary>
    ...
    /// PT-br: Registra o executor AST da família MySQL para o nome de dialeto informado.
    /// </summary>
    /// <param name="dialectName">EN: Dialect name exposed to the executor factory. PT-br: Nome do dialeto exposto à factory de executores.</param>
