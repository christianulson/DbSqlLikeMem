...
/// PT-br: Executa os testes compartilhados de CsvLoader e índices usando a implementação simulado de Db2.
/// </summary>
/// <param name="helper">
    ...
    ) : CsvLoaderAndIndexTestBase<Db2DbMock, Db2MockException>(helper)
{
    ...
    /// PT-br: Cria um novo banco simulado de Db2 para cada execução de teste.
    /// </summary>
