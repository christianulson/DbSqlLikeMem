...
/// PT-br: Executa os testes compartilhados de EXISTS/NOT EXISTS usando a conexão simulada de Db2.
/// </summary>
/// <param name="helper">
    ...
    ) : ExistsTestsBase(helper)
{
    ...
    /// PT-br: Cria uma conexão simulada de Db2 usada pelos testes compartilhados de EXISTS.
    /// </summary>
