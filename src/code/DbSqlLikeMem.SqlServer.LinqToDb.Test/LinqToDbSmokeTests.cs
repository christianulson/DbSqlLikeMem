...
/// PT-br: Executa testes compartilhados de contrato smoke de LinqToDB usando a fábrica de conexão do provedor SqlServer.
/// </summary>
...
) : LinqToDbSupportTestsBase(helper)
{
    ...
    /// PT-br: Cria a fábrica de conexão LinqToDB de SqlServer usada pelos testes de contrato compartilhados.
    /// </summary>
