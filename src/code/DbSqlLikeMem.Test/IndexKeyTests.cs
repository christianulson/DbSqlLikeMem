...
/// PT-br: Cobre a igualdade de chaves compostas e a ordem dos valores usadas em buscas de indice.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// PT-br: Verifica que valores equivalentes de string e nulos geram chaves iguais e hashes iguais.
    /// </summary>
    [Fact]
    [Trait("Category", "Core")]
    ...
    /// PT-br: Verifica que a lista de valores exposta preserva a ordem original da chave.
    /// </summary>
    [Fact]
    [Trait("Category", "Core")]
