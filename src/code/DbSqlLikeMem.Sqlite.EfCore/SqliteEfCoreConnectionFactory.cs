...
/// PT-br: Cria conexões simulado Sqlite abertas para pontos de integração com EF Core.
/// </summary>
public sealed class SqliteEfCoreConnectionFactory : IDbSqlLikeMemEfCoreConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Sqlite para EF Core sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Sqlite para EF Core que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Sqlite para EF Core que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
