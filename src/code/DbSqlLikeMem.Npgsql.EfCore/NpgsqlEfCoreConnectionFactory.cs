...
/// PT-br: Cria conexões simulado Npgsql abertas para pontos de integração com EF Core.
/// </summary>
public sealed class NpgsqlEfCoreConnectionFactory : IDbSqlLikeMemEfCoreConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Npgsql para EF Core sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Npgsql para EF Core que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Npgsql para EF Core que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
