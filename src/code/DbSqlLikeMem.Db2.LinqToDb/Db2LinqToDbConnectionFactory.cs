...
/// PT-br: Cria conexões simulado Db2 abertas para pontos de integração com LinqToDB.
/// </summary>
public sealed class Db2LinqToDbConnectionFactory : IDbSqlLikeMemLinqToDbConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Db2 para LinqToDB sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Db2 para LinqToDB que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Db2 para LinqToDB que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
    ...
    /// PT-br: Cria e abre uma conexão simulada Db2 apoiada por um banco em memória do DbSqlLikeMem.
    /// </summary>
