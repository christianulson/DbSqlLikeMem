...
/// PT-br: Cobre cenarios de gap de compatibilidade SQL do SQLite que documentam intencionalmente as divergencias atuais em relacao ao SQLite real.
/// </summary>
public sealed class SqliteSqlCompatibilityGapTests : XUnitTestBase
{
    ...
    /// PT-br: Cria a conexao SQLite em memoria usada pelos testes de gap de compatibilidade SQL.
    /// </summary>
...
").ToList();
    ...
    /// PT-br: Verifica se queries com CTE respeitam a versao SQLite configurada.
    /// </summary>
    [Fact]
    [Trait("Category", "SqliteSqlCompatibilityGap")]
    ...
    /// PT-br: Verifica se casts implicitos e comparacao de strings seguem os padroes do SQLite.
    /// </summary>
    [Fact]
    [Trait("Category", "SqliteSqlCompatibilityGap")]
