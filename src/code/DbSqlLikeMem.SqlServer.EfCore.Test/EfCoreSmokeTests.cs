...
/// PT-br: Executa testes compartilhados de contrato smoke de EF Core usando a fábrica de conexão do provedor SqlServer.
/// </summary>
...
) : EfCoreSupportTestsBase(helper)
{
    ...
    /// PT-br: Cria a fábrica de conexão EF Core de SqlServer usada pelos testes de contrato compartilhados.
    /// </summary>
