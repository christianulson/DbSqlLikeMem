...
/// <summary>
/// EN: Covers transaction commit and rollback scenarios in the Oracle mock.
/// PT-br: Cobre cenarios de commit e rollback de transacao no mock Oracle.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// PT-br: Garante que liberar um savepoint sem uma transação ativa mantenha a mensagem acionável em runtime no Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT-br: Garante que criar um savepoint sem uma transacao ativa mantenha a mensagem acionavel em runtime no Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT-br: Garante que rollback para savepoint sem uma transacao ativa mantenha a mensagem acionavel em runtime no Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT-br: Garante que liberar um savepoint mantenha a mensagem padronizada de nao suportado no Oracle quando release-savepoint esta desabilitado.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT-br: Garante que criar um savepoint com nome em branco mantenha a mensagem de validacao de parametro no Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT-br: Garante que executar rollback para um savepoint com nome em branco mantenha a mensagem de validacao de parametro no Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT-br: Garante que chamadas de release-savepoint nao suportadas mantenham o diagnostico padronizado no Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
