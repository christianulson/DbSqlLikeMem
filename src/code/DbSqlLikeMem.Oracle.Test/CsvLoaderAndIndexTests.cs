...
/// PT-br: Executa os testes compartilhados de CsvLoader e índices usando a implementação simulado de Oracle.
/// </summary>
/// <param name="helper">
    ...
    ) : CsvLoaderAndIndexTestBase<OracleDbMock, OracleMockException>(helper)
{
    ...
    /// PT-br: Cria um novo banco simulado de Oracle para cada execução de teste.
    /// </summary>
