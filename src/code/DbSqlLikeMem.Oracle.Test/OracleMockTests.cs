...
/// PT-br: Cobre comportamento de CRUD, transacoes, batch, temporal e RETURNING INTO do mock Oracle.
/// </summary>
    ...
    : XUnitTestBase
{
    ...
    /// PT-br: Cria o banco mock Oracle usado pela suite de testes.
    /// </summary>
    ...
    /// PT-br: Verifica se INSERT adiciona uma linha no mock Oracle.
    /// </summary>
    [Fact]
    ...
    /// PT-br: Verifica se defaults de sequence atribuem o proximo valor do Oracle quando a coluna e omitida.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se AddItem preserva propriedades omitidas para que defaults de coluna sejam aplicados.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se UPDATE modifica uma linha existente no mock Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se DELETE remove uma linha existente no mock Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se funcoes temporais podem ser usadas em clausulas SELECT e WHERE.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica que o Oracle rejeita FOUND_ROWS porque o provider expoe ROW_COUNT para inspecao de contagem de linhas.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se RELEASE SAVEPOINT emite o erro padronizado de nao suportado em lotes Oracle.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se INSERT ... RETURNING INTO preenche o parametro de saida.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se o parsing de RETURNING INTO ignora texto semelhante a palavra-chave dentro de literais.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se UPDATE ... RETURNING INTO preenche o parametro de saida.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
    ...
    /// PT-br: Verifica se DELETE ... RETURNING INTO preenche o parametro de saida.
    /// </summary>
    [Fact]
    [Trait("Category", "OracleMock")]
