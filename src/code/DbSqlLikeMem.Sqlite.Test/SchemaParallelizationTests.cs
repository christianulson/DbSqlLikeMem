...
/// PT-br: Cobre backup e restore em nivel de schema quando o trabalho das tabelas executa em paralelo em um banco thread-safe.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// PT-br: Verifica se backup, restore e limpeza de backup mantêm os dados das tabelas consistentes em multiplas tabelas.
    /// </summary>
    [Fact]
