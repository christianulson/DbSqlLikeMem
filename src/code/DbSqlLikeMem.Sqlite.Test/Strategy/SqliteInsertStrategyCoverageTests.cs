...
/// PT-br: Cobre cenarios de INSERT com multiplas linhas e baseado em SELECT no mock Sqlite.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// PT-br: Verifica se omitir a coluna identity permite ao SQLite gerar o valor.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
