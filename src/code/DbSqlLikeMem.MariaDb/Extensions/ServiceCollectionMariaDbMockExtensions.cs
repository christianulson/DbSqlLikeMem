...
/// PT-br: Fornece extensoes de injecao de dependencia para registrar instancias de MariaDbDbMock.
/// </summary>
public static class ServiceCollectionMariaDbMockExtensions
{
    /// <summary>
    /// EN: Registers MariaDbDbMock as a singleton service.
    /// PT-br: Registra MariaDbDbMock como servico singleton.
    /// </summary>
    ...
    /// PT-br: Registra MariaDbDbMock como servico com escopo.
    /// </summary>
    ...
    /// PT-br: Registra MariaDbDbMock como servico transient.
    /// </summary>
