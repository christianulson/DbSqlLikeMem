...
/// PT-br: Tenta inserir uma linha sem uma coluna NOT NULL obrigatoria e verifica se o provedor rejeita a operacao.
/// </summary>
        ...
        IBaseServiceTest
{
    ...
    /// PT-br: Insere uma linha que omite uma coluna NOT NULL obrigatoria e retorna true quando o provedor rejeita o insert.
    /// </summary>
    /// <param name="args">EN: Optional row id. PT-br: Id da linha opcional.</param>
