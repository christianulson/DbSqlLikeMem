        ...
        IBaseServiceTest
{
    ...
    /// PT-br: Executa varias instrucoes e lê o historico de planos de execucao do provedor.
    /// </summary>
    /// <param name="args">EN: Optional primary user id for the query that seeds the plan history. PT-br: Id principal opcional da consulta que alimenta o historico de planos.</param>
