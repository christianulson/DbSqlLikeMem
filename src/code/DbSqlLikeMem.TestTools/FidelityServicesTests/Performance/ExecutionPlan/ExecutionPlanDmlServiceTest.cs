        ...
        IBaseServiceTest
{
    ...
    /// PT-br: Executa um insert e lê o diagnostico de plano de execucao do provedor.
    /// </summary>
    /// <param name="args">EN: Optional insert id for the benchmark flow. PT-br: Id de insert opcional para o fluxo do benchmark.</param>
