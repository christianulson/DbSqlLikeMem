...
/// PT-br: Fornece testes de fidelidade DDL compartilhados para cenarios de tabela entre mock e container.
/// </summary>
    ...
    where T2 : DbConnection
{
    ...
    /// PT-br: Verifica se a criacao de tabela funciona para o provedor atual.
    /// </summary>
    [FidelityFact]
    ...
    /// PT-br: Verifica se a criacao de tabela com chave estrangeira funciona para o provedor atual.
    /// </summary>
    [FidelityFact]
    ...
    /// PT-br: Verifica se uma tabela criada com chave estrangeira aceita um insert referenciado valido para o provedor atual.
    /// </summary>
    [FidelityFact]
    ...
    /// PT-br: Verifica se a remocao de tabela funciona para o provedor atual.
    /// </summary>
    [FidelityFact]
