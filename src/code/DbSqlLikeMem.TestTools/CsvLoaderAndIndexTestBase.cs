...
/// PT-br: Testes compartilhados de CsvLoader e índices executados por classes derivadas de cada provedor.
/// </summary>
    ...
    where TSqlMockException : SqlMockException
{
    ...
    /// PT-br: Cria um simulado de banco específico do provedor usado por cada teste compartilhado de CsvLoader/índice.
    /// </summary>
    protected abstract TDbMock CreateDb();

    /// <summary>
    /// EN: Verifies CSV loading maps file columns to table columns by name.
    /// PT-br: Verifica se o carregamento CSV mapeia as colunas do arquivo para as colunas da tabela por nome.
    /// </summary>
    [Fact]
    ...
    /// PT-br: Verifica se colunas ausentes geram o erro especifico do provedor para coluna desconhecida.
    /// </summary>
    [Fact]
    [Trait("Category", "CsvLoaderAndIndex")]
    ...
    /// PT-br: Verifica se as consultas ao indice retornam as posicoes esperadas das linhas.
    /// </summary>
    [Fact]
    [Trait("Category", "CsvLoaderAndIndex")]
    ...
    /// PT-br: Verifica se backup e restore desfazem as mutacoes da tabela.
    /// </summary>
    [Fact]
    [Trait("Category", "CsvLoaderAndIndex")]
