...
/// PT-br: Descobre facts de fidelidade e os marca como ignorados quando a classe ou o metodo do teste expoe um marcador de skip.
/// </summary>
public sealed class FidelityFactDiscoverer : IXunitTestCaseDiscoverer
{
    ...
    /// PT-br: Cria um discoverer que pode montar test cases de fact de fidelidade.
    /// </summary>
