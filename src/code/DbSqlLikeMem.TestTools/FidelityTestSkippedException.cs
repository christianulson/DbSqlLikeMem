...
/// PT-br: Representa um skip de teste de fidelidade disparado por infraestrutura do provedor indisponivel ou configuracao de container ausente.
/// </summary>
public sealed class FidelityTestSkippedException : Exception
{
    /// <summary>
    /// EN: Creates a new skip exception with a default reason.
    /// PT-br: Cria uma nova excecao de skip com um motivo padrao.
    /// </summary>
    ...
    /// PT-br: Cria uma nova excecao de skip com o motivo informado.
    /// </summary>
    /// <param name="message">EN: Skip reason reported to the test runner. PT-br: Motivo do skip informado ao runner de testes.</param>
    ...
    /// PT-br: Cria uma nova excecao de skip com o motivo informado e inclui a mensagem da excecao interna.
    /// </summary>
    /// <param name="message">EN: Skip reason reported to the test runner. PT-br: Motivo do skip informado ao runner de testes.</param>
    /// <param name="innerException">EN: The exception whose message is appended to the skip reason. PT-br: A excecao cuja mensagem e adicionada ao motivo do skip.</param>
