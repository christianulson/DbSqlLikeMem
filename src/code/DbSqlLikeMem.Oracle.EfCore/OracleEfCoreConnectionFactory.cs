...
/// PT-br: Cria conexões simulado Oracle abertas para pontos de integração com EF Core.
/// </summary>
public sealed class OracleEfCoreConnectionFactory : IDbSqlLikeMemEfCoreConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Oracle para EF Core sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Oracle para EF Core que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Oracle para EF Core que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
