...
/// PT-br: Cobre cenarios adicionais de comportamento SQL Server para o provedor Dapper.
/// </summary>
public sealed class SqlServerAdditionalBehaviorCoverageTests(
    ITestOutputHelper helper
) : AdditionalBehaviorCoverageTestsBase<SqlServerDbMock, SqlServerConnectionMock>(helper)
{
    /// <inheritdoc />
