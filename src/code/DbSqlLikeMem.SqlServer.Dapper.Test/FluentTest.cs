...
/// <summary>
/// EN: Covers SQL Server fluent mapping scenarios against the Dapper provider.
/// PT-br: Cobre cenarios de mapeamento fluent SQL Server contra o provedor Dapper.
/// </summary>
