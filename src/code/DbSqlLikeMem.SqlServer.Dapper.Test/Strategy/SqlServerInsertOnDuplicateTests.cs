...
/// <summary>
/// EN: Covers SQL Server MERGE-based upsert scenarios against the Dapper provider.
/// PT-br: Cobre cenarios de upsert baseado em MERGE do SQL Server contra o provedor Dapper.
/// </summary>
