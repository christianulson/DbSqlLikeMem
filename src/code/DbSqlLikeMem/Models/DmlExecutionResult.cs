...
/// PT-br: Representa o resultado de uma operação DML (INSERT, UPDATE, DELETE) incluindo as linhas afetadas e seus índices.
/// </summary>
internal sealed class DmlExecutionResult
{
    ...
    /// PT-br: Cria um resultado para um numero especificado de linhas afetadas sem indices.
    /// </summary>
