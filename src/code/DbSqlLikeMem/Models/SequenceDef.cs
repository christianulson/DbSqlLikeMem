...
/// PT-br: Armazena a definicao e o estado atual de uma sequence do schema.
/// </summary>
public sealed class SequenceDef
{
    /// <summary>
    /// EN: Initializes a sequence definition with its numeric settings.
    /// PT-br: Inicializa uma definicao de sequence com suas configuracoes numericas.
    /// </summary>
    /// <param name="name">EN: Sequence name. PT-br: Nome da sequence.</param>
    /// <param name="startValue">EN: First value produced by the sequence. PT-br: Primeiro valor produzido pela sequence.</param>
    /// <param name="incrementBy">EN: Increment step between values. PT-br: Passo de incremento entre valores.</param>
    /// <param name="currentValue">EN: Current sequence value when known. PT-br: Valor atual da sequence quando conhecido.</param>
    ...
    /// PT-br: Gera o proximo valor e o armazena como valor atual.
    /// </summary>
    /// <returns>EN: Next sequence value. PT-br: Proximo valor da sequence.</returns>
