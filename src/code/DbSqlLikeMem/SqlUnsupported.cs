...
/// PT: Monta excecoes de operacao sem suporte com mensagens e dicas especificas do dialeto.
/// </summary>
internal static class SqlUnsupported
{
    /// <summary>
    /// EN: Formats the dialect label used in unsupported-operation messages.
    /// PT: Formata o rótulo do dialeto usado nas mensagens de operacao sem suporte.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para um recurso do dialeto.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para recursos do parser.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para recursos apenas do parser.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para clausulas WITH recursivas.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para MERGE e sugere uma alternativa especifica do dialeto.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para dicas de paginacao indisponiveis.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para clausulas ON CONFLICT.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para clausulas ON DUPLICATE KEY UPDATE.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para query hints.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida para instrucoes DELETE sem FROM.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida para instrucoes DELETE que apontam diretamente para um alias.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida para clausulas OFFSET/FETCH sem ORDER BY.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para instrucoes de nivel superior desconhecidas.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte para tipos de comando que nao sao suportados por um tipo de consulta.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando um nome de tabela nao existe.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando um nome de tabela normalizado nao existe.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando um savepoint nao pode ser encontrado.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando a operacao com savepoint exige uma transacao ativa.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando uma clausula de projeção DML precisa de uma tabela destino.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte quando uma expressao de projeção nao pode ser avaliada no executor.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando uma clausula de projeção esta vazia.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando um item de projeção esta vazio.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao sem suporte quando RETURNING INTO e usado fora de ExecuteNonQuery.
    /// </summary>
    ...
    /// PT: Cria uma excecao de operacao invalida quando RETURNING INTO tem quantidades diferentes de colunas e parametros.
    /// </summary>
