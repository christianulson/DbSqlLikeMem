...
/// PT: Contém as palavras-chave SQL e os tokens auxiliares compartilhados pelo parser e pelo pipeline de execução.
/// </summary>
public static class SqlConst
{
    ...
    /// PT: Palavra-chave SQL usada para iniciar uma instrução SELECT.
    /// </summary>
    public const string SELECT = "SELECT";
    /// <summary>
    /// EN: SQL keyword used to introduce a common table expression.
    /// PT: Palavra-chave SQL usada para introduzir uma expressao de tabela comum.
    /// </summary>
    public const string WITH = "WITH";
    /// <summary>
    /// EN: SQL keyword used to insert rows into a table.
    /// PT: Palavra-chave SQL usada para inserir linhas em uma tabela.
    /// </summary>
    public const string INSERT = "INSERT";
    /// <summary>
    /// EN: SQL keyword used to replace rows in dialects that support it.
    /// PT: Palavra-chave SQL usada para substituir linhas nos dialetos que a suportam.
    /// </summary>
    public const string REPLACE = "REPLACE";
    /// <summary>
    /// EN: SQL keyword used to update existing rows.
    /// PT: Palavra-chave SQL usada para atualizar linhas existentes.
    /// </summary>
    public const string UPDATE = "UPDATE";
    /// <summary>
    /// EN: SQL keyword used to delete rows.
    /// PT: Palavra-chave SQL usada para remover linhas.
    /// </summary>
    public const string DELETE = "DELETE";
    /// <summary>
    /// EN: SQL keyword used to merge source and target rows.
    /// PT: Palavra-chave SQL usada para mesclar linhas de origem e destino.
    /// </summary>
    public const string MERGE = "MERGE";
    /// <summary>
    /// EN: SQL keyword used to create database objects.
    /// PT: Palavra-chave SQL usada para criar objetos de banco de dados.
    /// </summary>
    public const string CREATE = "CREATE";
    /// <summary>
    /// EN: SQL keyword used to refer to a schema object.
    /// PT: Palavra-chave SQL usada para se referir a um objeto de schema.
    /// </summary>
    public const string SCHEMA = "SCHEMA";
    /// <summary>
    /// EN: SQL keyword used to recreate a database object.
    /// PT: Palavra-chave SQL usada para recriar um objeto de banco de dados.
    /// </summary>
    public const string RECREATE = "RECREATE";
    /// <summary>
    /// EN: SQL keyword used to alter an existing database object.
    /// PT: Palavra-chave SQL usada para alterar um objeto de banco de dados existente.
    /// </summary>
    public const string ALTER = "ALTER";
    /// <summary>
    /// EN: SQL keyword used to drop a database object.
    /// PT: Palavra-chave SQL usada para remover um objeto de banco de dados.
    /// </summary>
    public const string DROP = "DROP";
    /// <summary>
    /// EN: SQL keyword used to restart a sequence or generator.
    /// PT: Palavra-chave SQL usada para reiniciar uma sequence ou generator.
    /// </summary>
    public const string RESTART = "RESTART";
    /// <summary>
    /// EN: SQL keyword used to refer to an owned sequence or generator.
    /// PT: Palavra-chave SQL usada para se referir a uma sequence ou generator de propriedade.
    /// </summary>
    public const string OWNED = "OWNED";
    /// <summary>
    /// EN: SQL keyword used to declare a generator in Firebird-style syntax.
    /// PT: Palavra-chave SQL usada para declarar um generator em sintaxe estilo Firebird.
    /// </summary>
    public const string GENERATOR = "GENERATOR";
    /// <summary>
    /// EN: SQL keyword used to execute a block or statement.
    /// PT: Palavra-chave SQL usada para executar um bloco ou instrução.
    /// </summary>
    public const string EXECUTE = "EXECUTE";
    /// <summary>
    /// EN: SQL keyword used to mark an executable block.
    /// PT: Palavra-chave SQL usada para marcar um bloco executavel.
    /// </summary>
    public const string BLOCK = "BLOCK";
    /// <summary>
    /// EN: SQL keyword used to refer to a statement body.
    /// PT: Palavra-chave SQL usada para se referir ao corpo de uma instrução.
    /// </summary>
    public const string STATEMENT = "STATEMENT";
    /// <summary>
    /// EN: SQL keyword used to suspend execution in procedural blocks.
    /// PT: Palavra-chave SQL usada para suspender a execucao em blocos procedurais.
    /// </summary>
    public const string SUSPEND = "SUSPEND";
    /// <summary>
    /// EN: SQL keyword used to exit a block or loop.
    /// PT: Palavra-chave SQL usada para sair de um bloco ou loop.
    /// </summary>
    public const string EXIT = "EXIT";
    /// <summary>
    /// EN: SQL keyword used to break a loop.
    /// PT: Palavra-chave SQL usada para interromper um loop.
    /// </summary>
    public const string BREAK = "BREAK";
    /// <summary>
    /// EN: SQL keyword used to leave a loop or block.
    /// PT: Palavra-chave SQL usada para sair de um loop ou bloco.
    /// </summary>
    public const string LEAVE = "LEAVE";
    /// <summary>
    /// EN: SQL keyword used to target the destination of an INSERT or SELECT INTO statement.
    /// PT: Palavra-chave SQL usada para indicar o destino de uma instrução INSERT ou SELECT INTO.
    /// </summary>
    public const string INTO = "INTO";
    /// <summary>
    /// EN: SQL keyword used to refer to a single value in Firebird-style syntax.
    /// PT: Palavra-chave SQL usada para se referir a um unico valor em sintaxe estilo Firebird.
    /// </summary>
    public const string VALUE = "VALUE";
    /// <summary>
    /// EN: SQL keyword used to refer to multiple values in an INSERT statement.
    /// PT: Palavra-chave SQL usada para se referir a varios valores em uma instrução INSERT.
    /// </summary>
    public const string VALUES = "VALUES";
    /// <summary>
    /// EN: SQL keyword used to address a partition in partition-aware statements.
    /// PT: Palavra-chave SQL usada para identificar uma particao em instrucoes com particionamento.
    /// </summary>
    public const string PARTITION = "PARTITION";
    /// <summary>
    /// EN: SQL keyword used for duplicate-key handling in insert conflicts.
    /// PT: Palavra-chave SQL usada para tratamento de chave duplicada em conflitos de insert.
    /// </summary>
    public const string DUPLICATE = "DUPLICATE";
    /// <summary>
    /// EN: SQL keyword used to introduce a filter predicate.
    /// PT: Palavra-chave SQL usada para introduzir um predicado de filtro.
    /// </summary>
    public const string WHERE = "WHERE";
    /// <summary>
    /// EN: SQL keyword used to reference a source table or query.
    /// PT: Palavra-chave SQL usada para referenciar uma tabela ou consulta de origem.
    /// </summary>
    public const string FROM = "FROM";
    /// <summary>
    /// EN: SQL keyword used to refer to the source of an update or delete.
    /// PT: Palavra-chave SQL usada para referenciar a origem de um update ou delete.
    /// </summary>
    public const string USING = "USING";
    /// <summary>
    /// EN: SQL keyword used to join result sets.
    /// PT: Palavra-chave SQL usada para unir conjuntos de resultados.
    /// </summary>
    public const string JOIN = "JOIN";
    /// <summary>
    /// EN: SQL keyword used to request an inner join.
    /// PT: Palavra-chave SQL usada para solicitar um inner join.
    /// </summary>
    public const string INNER = "INNER";
    /// <summary>
    /// EN: SQL keyword used to request a left join.
    /// PT: Palavra-chave SQL usada para solicitar um left join.
    /// </summary>
    public const string LEFT = "LEFT";
    /// <summary>
    /// EN: SQL keyword used to request a right join.
    /// PT: Palavra-chave SQL usada para solicitar um right join.
    /// </summary>
    public const string RIGHT = "RIGHT";
    /// <summary>
    /// EN: SQL keyword used to request a full join.
    /// PT: Palavra-chave SQL usada para solicitar um full join.
    /// </summary>
    public const string FULL = "FULL";
    /// <summary>
    /// EN: SQL keyword used to request a cross join.
    /// PT: Palavra-chave SQL usada para solicitar um cross join.
    /// </summary>
    public const string CROSS = "CROSS";
    /// <summary>
    /// EN: SQL keyword used to request an outer join.
    /// PT: Palavra-chave SQL usada para solicitar um outer join.
    /// </summary>
    public const string OUTER = "OUTER";
    /// <summary>
    /// EN: SQL keyword used to request an APPLY join.
    /// PT: Palavra-chave SQL usada para solicitar um join APPLY.
    /// </summary>
    public const string APPLY = "APPLY";
    /// <summary>
    /// EN: SQL keyword used to introduce a join predicate.
    /// PT: Palavra-chave SQL usada para introduzir um predicado de join.
    /// </summary>
    public const string ON = "ON";
    /// <summary>
    /// EN: SQL keyword used to start a grouping clause.
    /// PT: Palavra-chave SQL usada para iniciar uma clausula de agrupamento.
    /// </summary>
    public const string GROUP = "GROUP";
    /// <summary>
    /// EN: SQL keyword used to combine grouped items.
    /// PT: Palavra-chave SQL usada para combinar itens agrupados.
    /// </summary>
    public const string BY = "BY";
    /// <summary>
    /// EN: SQL keyword used to start an ordering clause.
    /// PT: Palavra-chave SQL usada para iniciar uma clausula de ordenacao.
    /// </summary>
    public const string ORDER = "ORDER";
    /// <summary>
    /// EN: SQL keyword used to introduce a HAVING predicate.
    /// PT: Palavra-chave SQL usada para introduzir um predicado HAVING.
    /// </summary>
    public const string HAVING = "HAVING";
    /// <summary>
    /// EN: SQL keyword used to reference a view object.
    /// PT: Palavra-chave SQL usada para referenciar um objeto de view.
    /// </summary>
    public const string VIEW = "VIEW";
    /// <summary>
    /// EN: SQL keyword used to mark a uniqueness constraint.
    /// PT: Palavra-chave SQL usada para marcar uma restricao de unicidade.
    /// </summary>
    public const string UNIQUE = "UNIQUE";
    /// <summary>
    /// EN: SQL keyword used to reference an index object.
    /// PT: Palavra-chave SQL usada para referenciar um objeto de indice.
    /// </summary>
    public const string INDEX = "INDEX";
    /// <summary>
    /// EN: SQL keyword used to reference a stored function.
    /// PT: Palavra-chave SQL usada para referenciar uma funcao armazenada.
    /// </summary>
    public const string FUNCTION = "FUNCTION";
    /// <summary>
    /// EN: SQL keyword used to reference a stored procedure.
    /// PT: Palavra-chave SQL usada para referenciar uma procedure armazenada.
    /// </summary>
    public const string PROCEDURE = "PROCEDURE";
    /// <summary>
    /// EN: SQL keyword used to reference a trigger object.
    /// PT: Palavra-chave SQL usada para referenciar um objeto trigger.
    /// </summary>
    public const string TRIGGER = "TRIGGER";
    /// <summary>
    /// EN: SQL keyword used to mark a BEFORE trigger.
    /// PT: Palavra-chave SQL usada para marcar um trigger BEFORE.
    /// </summary>
    public const string BEFORE = "BEFORE";
    /// <summary>
    /// EN: SQL keyword used to mark an AFTER trigger.
    /// PT: Palavra-chave SQL usada para marcar um trigger AFTER.
    /// </summary>
    public const string AFTER = "AFTER";
    /// <summary>
    /// EN: SQL keyword used to mark a temporary object.
    /// PT: Palavra-chave SQL usada para marcar um objeto temporario.
    /// </summary>
    public const string TEMPORARY = "TEMPORARY";
    /// <summary>
    /// EN: SQL keyword used to mark a global temporary object.
    /// PT: Palavra-chave SQL usada para marcar um objeto temporario global.
    /// </summary>
    public const string GLOBAL = "GLOBAL";
    /// <summary>
    /// EN: SQL keyword used as a shorthand for temporary.
    /// PT: Palavra-chave SQL usada como abreviacao de temporary.
    /// </summary>
    public const string TEMP = "TEMP";
    /// <summary>
    /// EN: SQL keyword used to reference a table object.
    /// PT: Palavra-chave SQL usada para referenciar um objeto de tabela.
    /// </summary>
    public const string TABLE = "TABLE";
    /// <summary>
    /// EN: SQL keyword used for conditional creation or alteration.
    /// PT: Palavra-chave SQL usada para criacao ou alteracao condicional.
    /// </summary>
    public const string IF = "IF";
    /// <summary>
    /// EN: SQL keyword used to start a sequence or generator definition.
    /// PT: Palavra-chave SQL usada para iniciar a definicao de uma sequence ou generator.
    /// </summary>
    public const string START = "START";
    /// <summary>
    /// EN: SQL keyword used to mark an autonomous transaction.
    /// PT: Palavra-chave SQL usada para marcar uma transacao autonoma.
    /// </summary>
    public const string AUTONOMOUS = "AUTONOMOUS";
    /// <summary>
    /// EN: SQL keyword used to mark a common object.
    /// PT: Palavra-chave SQL usada para marcar um objeto comum.
    /// </summary>
    public const string COMMON = "COMMON";
    /// <summary>
    /// EN: SQL keyword used to mark caller privileges or context.
    /// PT: Palavra-chave SQL usada para marcar privilegios ou contexto do chamador.
    /// </summary>
    public const string CALLER = "CALLER";
    /// <summary>
    /// EN: SQL keyword used to request elevated privileges in a routine body.
    /// PT: Palavra-chave SQL usada para solicitar privilegios elevados em um corpo de rotina.
    /// </summary>
    public const string PRIVILEGES = "PRIVILEGES";
    /// <summary>
    /// EN: SQL keyword used to reference a transaction object.
    /// PT: Palavra-chave SQL usada para referenciar um objeto de transacao.
    /// </summary>
    public const string TRANSACTION = "TRANSACTION";
    /// <summary>
    /// EN: SQL keyword used to define the increment of a sequence.
    /// PT: Palavra-chave SQL usada para definir o incremento de uma sequence.
    /// </summary>
    public const string INCREMENT = "INCREMENT";
    /// <summary>
    /// EN: SQL keyword used to declare an output parameter.
    /// PT: Palavra-chave SQL usada para declarar um parametro de saida.
    /// </summary>
    public const string OUT = "OUT";
    /// <summary>
    /// EN: SQL keyword used to declare an input/output parameter.
    /// PT: Palavra-chave SQL usada para declarar um parametro de entrada e saida.
    /// </summary>
    public const string INOUT = "INOUT";
    /// <summary>
    /// EN: SQL keyword used to declare the return type of a routine.
    /// PT: Palavra-chave SQL usada para declarar o tipo de retorno de uma rotina.
    /// </summary>
    public const string RETURNS = "RETURNS";
    /// <summary>
    /// EN: SQL keyword used to return a scalar value.
    /// PT: Palavra-chave SQL usada para retornar um valor escalar.
    /// </summary>
    public const string RETURN = "RETURN";
    /// <summary>
    /// EN: SQL keyword used to start a routine body.
    /// PT: Palavra-chave SQL usada para iniciar o corpo de uma rotina.
    /// </summary>
    public const string BEGIN = "BEGIN";
    /// <summary>
    /// EN: SQL keyword used to mark each row in a trigger body.
    /// PT: Palavra-chave SQL usada para marcar cada linha no corpo de um trigger.
    /// </summary>
    public const string EACH = "EACH";
    /// <summary>
    /// EN: SQL keyword used for IS predicates.
    /// PT: Palavra-chave SQL usada para predicados IS.
    /// </summary>
    public const string IS = "IS";
    /// <summary>
    /// EN: SQL keyword used to introduce referenced rows in trigger syntax.
    /// PT: Palavra-chave SQL usada para introduzir linhas referenciadas em sintaxe de trigger.
    /// </summary>
    public const string REFERENCING = "REFERENCING";
    /// <summary>
    /// EN: SQL keyword used to identify a trigger mode.
    /// PT: Palavra-chave SQL usada para identificar um modo de trigger.
    /// </summary>
    public const string MODE = "MODE";
    /// <summary>
    /// EN: SQL keyword used to mark an atomic block.
    /// PT: Palavra-chave SQL usada para marcar um bloco atomico.
    /// </summary>
    public const string ATOMIC = "ATOMIC";
    /// <summary>
    /// EN: SQL keyword used to declare a language for a routine.
    /// PT: Palavra-chave SQL usada para declarar uma linguagem de rotina.
    /// </summary>
    public const string LANGUAGE = "LANGUAGE";
    /// <summary>
    /// EN: SQL keyword used to reference a column object.
    /// PT: Palavra-chave SQL usada para referenciar um objeto de coluna.
    /// </summary>
    public const string COLUMN = "COLUMN";
    /// <summary>
    /// EN: SQL keyword used to add a table element.
    /// PT: Palavra-chave SQL usada para adicionar um elemento de tabela.
    /// </summary>
    public const string ADD = "ADD";
    /// <summary>
    /// EN: SQL keyword used to request a count aggregate.
    /// PT: Palavra-chave SQL usada para solicitar um agregado de contagem.
    /// </summary>
    public const string COUNT = "COUNT";
    /// <summary>
    /// EN: SQL keyword used to request a bigint count aggregate.
    /// PT: Palavra-chave SQL usada para solicitar um agregado de contagem bigint.
    /// </summary>
    public const string COUNT_BIG = "COUNT_BIG";
    /// <summary>
    /// EN: SQL keyword used for JSON object aggregation in some dialects.
    /// PT: Palavra-chave SQL usada para agregacao de objetos JSON em alguns dialetos.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para agregacao unica e estrita de objetos JSON.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para agregacao de objetos JSONB.
    /// </summary>
    public const string JSONB_OBJECT_AGG = "JSONB_OBJECT_AGG";
    /// <summary>
    /// EN: SQL keyword used for strict JSONB object aggregation.
    /// PT: Palavra-chave SQL usada para agregacao estrita de objetos JSONB.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para agregacao unica de objetos JSONB.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para agregacao unica e estrita de objetos JSONB.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para agregacao de variancia amostral.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para agregacao do coeficiente de variacao.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para limitacao de linhas com TOP.
    /// </summary>
    public const string TOP = "TOP";
    /// <summary>
    /// EN: SQL keyword used for LIMIT row limiting.
    /// PT: Palavra-chave SQL usada para limitacao de linhas com LIMIT.
    /// </summary>
    public const string LIMIT = "LIMIT";
    /// <summary>
    /// EN: SQL keyword used for OFFSET row skipping.
    /// PT: Palavra-chave SQL usada para pular linhas com OFFSET.
    /// </summary>
    public const string OFFSET = "OFFSET";
    /// <summary>
    /// EN: SQL keyword used for FETCH row limiting.
    /// PT: Palavra-chave SQL usada para limitacao de linhas com FETCH.
    /// </summary>
    public const string FETCH = "FETCH";
    /// <summary>
    /// EN: SQL keyword used for SKIP row skipping.
    /// PT: Palavra-chave SQL usada para pular linhas com SKIP.
    /// </summary>
    public const string SKIP = "SKIP";
    /// <summary>
    /// EN: SQL keyword used for Oracle-style row limiting with ROWNUM.
    /// PT: Palavra-chave SQL usada para limitacao de linhas em estilo Oracle com ROWNUM.
    /// </summary>
    public const string ROWNUM = "ROWNUM";
    /// <summary>
    /// EN: SQL keyword used for NEXT row limiting.
    /// PT: Palavra-chave SQL usada para limitacao de linhas com NEXT.
    /// </summary>
    public const string NEXT = "NEXT";
    /// <summary>
    /// EN: SQL keyword used for FIRST row limiting.
    /// PT: Palavra-chave SQL usada para limitacao de linhas com FIRST.
    /// </summary>
    public const string FIRST = "FIRST";
    /// <summary>
    /// EN: SQL keyword used for row limiting with ROW.
    /// PT: Palavra-chave SQL usada para limitacao de linhas com ROW.
    /// </summary>
    public const string ROW = "ROW";
    /// <summary>
    /// EN: SQL keyword used for row limiting with ROWS.
    /// PT: Palavra-chave SQL usada para limitacao de linhas com ROWS.
    /// </summary>
    public const string ROWS = "ROWS";
    /// <summary>
    /// EN: SQL keyword used to specify an upper bound for a row range.
    /// PT: Palavra-chave SQL usada para especificar o limite superior de um intervalo de linhas.
    /// </summary>
    public const string TO = "TO";
    /// <summary>
    /// EN: SQL keyword used to request a single row in limiting syntax.
    /// PT: Palavra-chave SQL usada para solicitar uma unica linha na sintaxe de limitacao.
    /// </summary>
    public const string ONLY = "ONLY";
    /// <summary>
    /// EN: Composite token used to describe OFFSET/FETCH pagination.
    /// PT: Token composto usado para descrever paginacao OFFSET/FETCH.
    /// </summary>
    public const string OFFSET_FETCH = "OFFSET/FETCH";
    /// <summary>
    /// EN: Composite token used to describe FETCH FIRST/NEXT pagination.
    /// PT: Token composto usado para descrever paginacao FETCH FIRST/NEXT.
    /// </summary>
    ...
    /// PT: Quantificador SQL usado para predicados universais.
    /// </summary>
    public const string ALL = "ALL";
    /// <summary>
    /// EN: SQL keyword used to name aliases.
    /// PT: Palavra-chave SQL usada para nomear aliases.
    /// </summary>
    public const string AS = "AS";
    /// <summary>
    /// EN: SQL keyword used in searched CASE expressions.
    /// PT: Palavra-chave SQL usada em expressoes CASE pesquisadas.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada em expressoes CASE.
    /// </summary>
    public const string ELSE = "ELSE";
    /// <summary>
    /// EN: SQL keyword used to close CASE and block constructs.
    /// PT: Palavra-chave SQL usada para encerrar CASE e construtos de bloco.
    /// </summary>
    public const string END = "END";
    /// <summary>
    /// EN: SQL keyword used to test for existence.
    /// PT: Palavra-chave SQL usada para testar existencia.
    /// </summary>
    public const string EXISTS = "EXISTS";
    /// <summary>
    /// EN: SQL keyword used in IN predicates.
    /// PT: Palavra-chave SQL usada em predicados IN.
    /// </summary>
    public const string IN = "IN";
    /// <summary>
    /// EN: SQL keyword used for scalar subquery contexts.
    /// PT: Palavra-chave SQL usada para contextos de subconsulta escalar.
    /// </summary>
    public const string SCALAR = "SCALAR";
    /// <summary>
    /// EN: Token prefix used for quantified ANY predicates.
    /// PT: Prefixo de token usado para predicados ANY quantificados.
    /// </summary>
    public const string QANY = "QANY_";
    /// <summary>
    /// EN: Token prefix used for quantified ALL predicates.
    /// PT: Prefixo de token usado para predicados ALL quantificados.
    /// </summary>
    public const string QALL = "QALL_";
    /// <summary>
    /// EN: SQL keyword used for logical OR.
    /// PT: Palavra-chave SQL usada para OR logico.
    /// </summary>
    public const string OR = "OR";
    /// <summary>
    /// EN: SQL keyword used for BETWEEN predicates.
    /// PT: Palavra-chave SQL usada para predicados BETWEEN.
    /// </summary>
    public const string BETWEEN = "BETWEEN";
    /// <summary>
    /// EN: SQL keyword used for logical AND.
    /// PT: Palavra-chave SQL usada para AND logico.
    /// </summary>
    public const string AND = "AND";
    /// <summary>
    /// EN: Helper token containing a spaced AND fragment.
    /// PT: Token auxiliar contendo um fragmento AND com espacos.
    /// </summary>
    public const string _AND_ = " AND ";
    /// <summary>
    /// EN: SQL keyword used in DML ON DUPLICATE DO/SET clauses.
    /// PT: Palavra-chave SQL usada em clausulas DO/SET de ON DUPLICATE.
    /// </summary>
    public const string DO = "DO";
    /// <summary>
    /// EN: SQL keyword used to set assignment targets.
    /// PT: Palavra-chave SQL usada para definir destinos de atribuicao.
    /// </summary>
    public const string SET = "SET";
    /// <summary>
    /// EN: SQL keyword used to ignore a duplicate-row outcome.
    /// PT: Palavra-chave SQL usada para ignorar um resultado de linha duplicada.
    /// </summary>
    public const string NOTHING = "NOTHING";
    /// <summary>
    /// EN: SQL keyword used to represent no value.
    /// PT: Palavra-chave SQL usada para representar nenhum valor.
    /// </summary>
    public const string NONE = "NONE";
    /// <summary>
    /// EN: SQL keyword used to return values from DML statements.
    /// PT: Palavra-chave SQL usada para retornar valores de instrucoes DML.
    /// </summary>
    public const string RETURNING = "RETURNING";
    /// <summary>
    /// EN: SQL keyword used to mark a matched merge branch.
    /// PT: Palavra-chave SQL usada para marcar um ramo matched do merge.
    /// </summary>
    public const string MATCHED = "MATCHED";
    /// <summary>
    /// EN: SQL keyword used to negate a predicate.
    /// PT: Palavra-chave SQL usada para negar um predicado.
    /// </summary>
    public const string NOT = "NOT";
    /// <summary>
    /// EN: SQL keyword used to denote the absence of a condition or source.
    /// PT: Palavra-chave SQL usada para denotar ausencia de condicao ou origem.
    /// </summary>
    public const string NO = "NO";
    /// <summary>
    /// EN: SQL keyword used to introduce a FOR clause.
    /// PT: Palavra-chave SQL usada para introduzir uma clausula FOR.
    /// </summary>
    public const string FOR = "FOR";
    /// <summary>
    /// EN: SQL keyword used for query or DML options.
    /// PT: Palavra-chave SQL usada para opcoes de consulta ou DML.
    /// </summary>
    public const string OPTION = "OPTION";
    /// <summary>
    /// EN: MySQL keyword used to request SQL_CALC_FOUND_ROWS behavior.
    /// PT: Palavra-chave MySQL usada para solicitar o comportamento SQL_CALC_FOUND_ROWS.
    /// </summary>
    ...
    /// PT: Palavra-chave SQL usada para fornecer um valor padrao.
    /// </summary>
    public const string DEFAULT = "DEFAULT";
    /// <summary>
    /// EN: SQL keyword used to represent a null literal.
    /// PT: Palavra-chave SQL usada para representar um literal nulo.
    /// </summary>
    public const string NULL = "NULL";
    /// <summary>
    /// EN: SQL keyword used to represent a true literal.
    /// PT: Palavra-chave SQL usada para representar um literal true.
    /// </summary>
    public const string TRUE = "TRUE";
    /// <summary>
    /// EN: SQL keyword used to represent a false literal.
    /// PT: Palavra-chave SQL usada para representar um literal false.
    /// </summary>
    public const string FALSE = "FALSE";
    /// <summary>
    /// EN: SQL keyword used to refer to a year part or interval unit.
    /// PT: Palavra-chave SQL usada para referenciar uma parte de ano ou unidade de intervalo.
    /// </summary>
    public const string YEAR = "YEAR";
    /// <summary>
    /// EN: SQL keyword used to request low-priority locking or execution.
    /// PT: Palavra-chave SQL usada para solicitar bloqueio ou execucao de baixa prioridade.
    /// </summary>
    public const string LOW_PRIORITY = "LOW_PRIORITY";
    /// <summary>
    /// EN: SQL keyword used to mark delayed processing.
    /// PT: Palavra-chave SQL usada para marcar processamento atrasado.
    /// </summary>
    public const string DELAYED = "DELAYED";
    /// <summary>
    /// EN: SQL keyword used to request high-priority locking or execution.
    /// PT: Palavra-chave SQL usada para solicitar bloqueio ou execucao de alta prioridade.
    /// </summary>
    public const string HIGH_PRIORITY = "HIGH_PRIORITY";
    /// <summary>
    /// EN: SQL keyword used to ignore conflicting rows in MySQL-style syntax.
    /// PT: Palavra-chave SQL usada para ignorar linhas em conflito em sintaxe estilo MySQL.
    /// </summary>
