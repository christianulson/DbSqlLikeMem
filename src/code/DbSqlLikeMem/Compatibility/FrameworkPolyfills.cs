...
namespace System.Runtime.CompilerServices
{
    ...
    /// PT-br: Fornece o tipo marcador do compilador usado por setters init-only em frameworks mais antigos.
    /// </summary>
...
namespace System.Runtime.CompilerServices
{
    ...
    /// PT-br: Fornece o atributo marcador do compilador usado para membros obrigatorios em frameworks mais antigos.
    /// </summary>
    ...
    /// PT-br: Fornece o atributo marcador do compilador usado para anotar recursos de linguagem obrigatorios em frameworks mais antigos.
    /// </summary>
    /// <remarks>
    /// EN: Stores the name of the required compiler feature.
    /// PT-br: Armazena o nome do recurso de compilador requerido.
    /// </remarks>
    ...
    public sealed class CompilerFeatureRequiredAttribute(string featureName) : Attribute
    {
        ...
        /// PT-br: Obtém o nome do recurso de compilador requerido.
        /// </summary>
        public string FeatureName { get; } = featureName;

        /// <summary>
        /// EN: Gets or sets whether the compiler feature is optional.
        /// PT-br: Obtém ou define se o recurso de compilador é opcional.
        /// </summary>
        public bool IsOptional { get; init; }

        /// <summary>
        /// EN: Identifies the ref structs compiler feature.
        /// PT-br: Identifica o recurso de compilador ref structs.
        /// </summary>
        public const string RefStructs = nameof(RefStructs);

        /// <summary>
        /// EN: Identifies the required members compiler feature.
        /// PT-br: Identifica o recurso de compilador required members.
        /// </summary>
...
namespace System.Diagnostics.CodeAnalysis
{
    ...
    /// PT-br: Fornece o atributo marcador do compilador usado para indicar que um construtor define todos os membros obrigatorios.
    /// </summary>
...
namespace System
{
    ...
    /// PT-br: Fornece uma implementacao de HashCode para frameworks alvo que nao incluem o tipo da BCL.
    /// </summary>
    public struct HashCode
    {
        ...
        /// PT-br: Adiciona um valor ao hash code acumulado.
        /// </summary>
        ...
        /// PT-br: Obtém o valor final do hash code.
        /// </summary>
...
namespace System.Diagnostics.CodeAnalysis
{
    ...
    /// PT-br: Fornece o atributo do compilador usado para permitir valores nulos em membros anotados em frameworks mais antigos.
    /// </summary>
...
namespace System.Diagnostics.CodeAnalysis
{
    ...
    /// PT-br: Fornece o atributo do compilador usado para indicar que um valor pode ser nulo em uma condicao de retorno especifica.
    /// </summary>
    /// <remarks>
    /// EN: Stores the return-value condition that controls the nullability annotation.
    /// PT-br: Armazena a condicao de retorno que controla a anotacao de nulabilidade.
    /// </remarks>
    /// <param name="returnValue">EN: Return condition used by the annotation. PT-br: Condicao de retorno usada pela anotacao.</param>
    ...
    public sealed class MaybeNullWhenAttribute(bool returnValue) : Attribute
    {
        ...
        /// PT-br: Obtém a condicao de retorno usada pela anotacao.
        /// </summary>
...
namespace DbSqlLikeMem
{
    ...
    /// PT-br: Fornece helpers para validar argumentos e garantir que nao sejam nulos.
    /// </summary>
    ...
    public static class ArgumentNullExceptionCompatible
    {
        ...
        /// PT-br: Lanca ArgumentNullException quando o valor e nulo.
        /// </summary>
        /// <param name="value">EN: Object value to validate. PT-br: Valor do objeto a validar.</param>
        /// <param name="paramName">EN: Parameter name used in the exception. PT-br: Nome do parametro usado na excecao.</param>
    ...
    /// PT-br: Fornece helpers para validar argumentos de metodo de forma compativel com os padroes de excecao do .NET.
    /// </summary>
    ...
    public static class ArgumentExceptionCompatible
    {
        ...
        /// PT-br: Lanca ArgumentException quando a string e nula, vazia ou apenas espacos.
        /// </summary>
        /// <param name="value">EN: String value to validate. PT-br: Valor de string a validar.</param>
        /// <param name="paramName">EN: Parameter name used in the exception. PT-br: Nome do parametro usado na excecao.</param>
    ...
    /// PT-br: Fornece helpers de clamp para valores comparaveis.
    /// </summary>
    public static class ClampExtensions
    {
        /// <summary>
        /// EN: Clamps a value to the inclusive range defined by the minimum and maximum values.
        /// PT-br: Limita um valor ao intervalo inclusivo definido pelos valores minimo e maximo.
        /// </summary>
    ...
    /// PT-br: Fornece calculos de ticks decorridos compativeis com o framework a partir de timestamps do Stopwatch.
    /// </summary>
    public static class StopwatchCompatible
    {
        ...
        /// PT-br: Converte um timestamp inicial de Stopwatch.GetTimestamp em ticks decorridos de TimeSpan.
        /// </summary>
