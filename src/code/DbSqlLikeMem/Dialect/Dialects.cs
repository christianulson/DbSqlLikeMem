...
/// PT-br: Estilos de escape de string suportados pelo parser.
/// </summary>
internal enum SqlStringEscapeStyle { backslash, doubled_quote }

/// <summary>
/// EN: Identifier escaping styles supported by the parser.
/// PT-br: Estilos de escape de identificador suportados pelo parser.
/// </summary>
...
/// PT-br: Define o tipo de funcao temporal avaliada.
/// </summary>
public enum SqlTemporalFunctionKind
{
    ...
    /// <summary>
    /// EN: Time value.
    /// PT-br: Valor de tempo.
    /// </summary>
    Time,
    /// <summary>
    /// EN: DateTime value.
    /// PT-br: Valor de data e hora.
    /// </summary>
    DateTime,
    /// <summary>
    /// EN: DateTimeOffset value.
    /// PT-br: Valor de data e hora com fuso horario.
    /// </summary>
    DateTimeOffset
}
