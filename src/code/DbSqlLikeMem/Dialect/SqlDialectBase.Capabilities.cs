...
internal abstract partial class SqlDialectBase
{
    ...
    /// PT: Indica se ALTER TABLE ADD COLUMN e suportado.
    /// </summary>
    ...
    /// PT: Indica se a sintaxe de identificador com duplo arroba e suportada.
    /// </summary>
    public virtual bool SupportsDoubleAtIdentifierSyntax => false;

    /// <summary>
    /// EN: Indicates whether SQL_CALC_FOUND_ROWS is supported.
    /// PT: Indica se SQL_CALC_FOUND_ROWS e suportado.
    /// </summary>
    ...
    /// PT: Indica se identificadores entre aspas compartilhados entre providers sao aceitos.
    /// </summary>
    ...
    /// PT: Indica se operadores JSON compartilhados entre providers sao aceitos.
    /// </summary>
    ...
    /// PT: Indica se sufixos de upsert em INSERT ... SELECT sao aceitos.
    /// </summary>
    ...
    /// PT: Indica se o parsing de compatibilidade para DELETE sem FROM e aceito.
    /// </summary>
    ...
    /// PT: Indica se o parsing de compatibilidade para LIMIT/OFFSET e aceito.
    /// </summary>
    ...
    /// PT: Indica se identificadores com hash na frente sao aceitos.
    /// </summary>
    public virtual bool AllowsHashIdentifiers => false;

    /// <summary>
    /// EN: Gets the temporary table scope used by the dialect.
    /// PT: Obtém o escopo de tabela temporaria usado pelo dialeto.
    /// </summary>
    ...
    /// PT: Tenta mapear um token de operador binario analisado para o operador do dialeto.
    /// </summary>
