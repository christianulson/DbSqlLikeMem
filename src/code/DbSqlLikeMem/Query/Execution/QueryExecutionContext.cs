...
internal sealed class QueryExecutionContext
{
    ...
    /// PT-br: Indica se os snapshots de dados de linhas afetadas devem ser capturados durante operações DML.
    /// </summary>
    ...
    /// PT-br: Indica se bloqueio thread-safe deve ser usado durante mutações de tabelas.
    /// </summary>
    ...
    /// PT-br: Cria um contexto de execução de query a partir de uma conexão, dialeto e coleção de parâmetros.
    /// </summary>
    ...
    /// PT-br: Reinicia o cursor de parametros posicionais usado para resolver placeholders SQL `?` em ordem.
    /// </summary>
    ...
    /// PT-br: Inicia um escopo de avaliacao de parametros posicionais e reinicia o cursor ao entrar no escopo mais externo.
    /// </summary>
    /// <returns>EN: A disposable scope that restores the nesting depth on exit. PT-br: Um escopo descartavel que restaura a profundidade de aninhamento ao sair.</returns>
    ...
    /// PT-br: Indica se um escopo de avaliacao de parametros posicionais esta ativo.
    /// </summary>
    ...
    /// PT-br: Cria uma copia rasa que preserva o cursor atual de parametros posicionais.
    /// </summary>
    ...
    /// PT-br: Avanca o cursor de parametros posicionais por uma quantidade fixa de placeholders consumidos.
    /// </summary>
    ...
    /// PT-br: Resolve o proximo valor de parametro posicional para a avaliacao atual da expressao.
    /// </summary>
    /// <returns>EN: The next positional parameter value, or null when none is available. PT-br: O proximo valor de parametro posicional, ou null quando nao houver nenhum.</returns>
    ...
    /// PT-br: Resolve o proximo valor de parametro posicional e informa se havia um valor disponivel.
    /// </summary>
    ...
    /// PT-br: Captura o estado atual dos cursores posicional e ordenado dos parametros.
    /// </summary>
    /// <returns>EN: The current cursor positions. PT-br: As posicoes atuais dos cursores.</returns>
    ...
    /// PT-br: Restaura um estado capturado anteriormente dos cursores posicional e ordenado dos parametros.
    /// </summary>
    ...
    /// PT-br: Cria um contexto a partir de uma conexão usando o dialeto de execução atual.
    /// </summary>
    ...
    /// PT-br: Constrói um snapshot de contexto de runtime mock para formatação de planos de execução.
    /// </summary>
    ...
    /// PT-br: Cria um executor de AST com escopo no dialeto e parâmetros deste contexto.
    /// </summary>
