...
/// PT-br: Captura o rastro de operadores em runtime produzido durante a execucao de um comando SQL no mecanismo simulado.
/// </summary>
public sealed class QueryDebugTrace
{
    ...
    /// PT-br: Inicializa um trace de runtime com o tipo da query, o contexto do statement e os passos ordenados de execucao.
    /// </summary>
    /// <param name="queryType">EN: Query kind represented by the trace, such as SELECT or UNION. PT-br: Tipo de query representado pelo trace, como SELECT ou UNION.</param>
    /// <param name="statementIndex">EN: Zero-based statement position inside the executed SQL batch. PT-br: Posicao do statement baseada em zero dentro do lote SQL executado.</param>
    /// <param name="sqlText">EN: SQL text associated with the captured statement, when available. PT-br: Texto SQL associado ao statement capturado, quando disponivel.</param>
    /// <param name="steps">EN: Ordered runtime steps captured during execution. PT-br: Passos de runtime ordenados capturados durante a execucao.</param>
...
/// PT-br: Descreve um passo de operador em runtime capturado por <see cref="QueryDebugTrace"/>.
/// </summary>
public sealed class QueryDebugTraceStep
{
    /// <summary>
    /// EN: Initializes one runtime operator step with row counts, elapsed time and details.
    /// PT-br: Inicializa um passo de operador em runtime com contagens de linhas, tempo decorrido e detalhes.
    /// </summary>
    /// <param name="operatorName">EN: Logical operator name, such as TableScan, Filter or Limit. PT-br: Nome logico do operador, como TableScan, Filter ou Limit.</param>
    /// <param name="inputRows">EN: Number of rows received by the operator. PT-br: Numero de linhas recebidas pelo operador.</param>
    /// <param name="outputRows">EN: Number of rows produced by the operator. PT-br: Numero de linhas produzidas pelo operador.</param>
    /// <param name="executionTime">EN: Time spent by the operator during runtime capture. PT-br: Tempo gasto pelo operador durante a captura em runtime.</param>
    /// <param name="details">EN: Optional human-readable detail about the operator. PT-br: Detalhe opcional legivel sobre o operador.</param>
    ...
    /// PT-br: Nome logico do operador capturado neste passo de runtime.
    /// </summary>
    public string Operator { get; }

    /// <summary>
    /// EN: Number of rows received by the operator.
    /// PT-br: Numero de linhas recebidas pelo operador.
    /// </summary>
    public int InputRows { get; }

    /// <summary>
    /// EN: Number of rows produced by the operator.
    /// PT-br: Numero de linhas produzidas pelo operador.
    /// </summary>
    public int OutputRows { get; }

    /// <summary>
    /// EN: Elapsed time captured for the operator execution.
    /// PT-br: Tempo decorrido capturado para a execucao do operador.
    /// </summary>
    public TimeSpan ExecutionTime { get; }

    /// <summary>
    /// EN: Optional detail that helps explain the operator step.
    /// PT-br: Detalhe opcional que ajuda a explicar o passo do operador.
    /// </summary>
