...
internal static class AggregateFunctionCatalog
{
    private static readonly HashSet<string> Names = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        SqlConst.COLLECT,"CORR","CORR_K","CORR_S","CORRELATION","COVAR_POP","COVAR_SAMP","COVARIANCE","COVARIANCE_SAMP",SqlConst.CV,SqlConst.JSON_OBJECTAGG,
