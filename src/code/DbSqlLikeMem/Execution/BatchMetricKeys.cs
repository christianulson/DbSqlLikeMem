...
internal static class BatchMetricKeys
{
    ...
    /// PT-br: Agrupa prefixos de chave de métrica para tipos de execução em lote.
    /// </summary>
    public static class TypePrefixes
    {
        /// <summary>
        /// EN: Metric key prefix for materialization counters.
        /// PT-br: Prefixo de chave de métrica para contadores de materializacao.
        /// </summary>
        public const string Materialize = "materialize:";
        /// <summary>
        /// EN: Metric key prefix for reader counters.
        /// PT-br: Prefixo de chave de métrica para contadores de leitura.
        /// </summary>
        public const string Reader = "reader:";
        /// <summary>
        /// EN: Metric key prefix for fallback non-query counters.
        /// PT-br: Prefixo de chave de métrica para contadores de fallback de non-query.
        /// </summary>
        public const string FallbackNonQuery = "fallback-nonquery:";
        /// <summary>
        /// EN: Metric key prefix for non-query counters.
        /// PT-br: Prefixo de chave de métrica para contadores de non-query.
        /// </summary>
        public const string NonQuery = "nonquery:";
        /// <summary>
        /// EN: Metric key prefix for scalar counters.
        /// PT-br: Prefixo de chave de métrica para contadores escalares.
        /// </summary>
        public const string Scalar = "scalar:";
    }
}
