...
/// PT-br: Adiciona latencia opcional e injecao deterministica de falhas a operacoes ADO.NET interceptadas.
/// </summary>
public sealed class FaultInjectionDbConnectionInterceptor : DbConnectionInterceptor
{
    ...
    /// PT-br: Latencia fixa aplicada antes da execucao de operacoes elegiveis.
    /// </summary>
    public TimeSpan Latency { get; init; }

    /// <summary>
    /// EN: Optional predicate that decides whether connection open should fail.
    /// PT-br: Predicado opcional que decide se a abertura da conexao deve falhar.
    /// </summary>
    ...
    /// PT-br: Predicado opcional que decide se a execucao do comando deve falhar.
    /// </summary>
    ...
    /// PT-br: Predicado opcional que decide se o inicio da transacao deve falhar.
    /// </summary>
    ...
    /// PT-br: Predicado opcional que decide se commit ou rollback devem falhar.
    /// </summary>
    ...
    /// PT-br: Fabrica usada para criar a excecao injetada de abertura de conexao.
    /// </summary>
    ...
    /// PT-br: Fabrica usada para criar a excecao injetada de comando.
    /// </summary>
    ...
    /// PT-br: Fabrica usada para criar a excecao injetada de inicio de transacao.
    /// </summary>
    ...
    /// PT-br: Fabrica usada para criar a excecao injetada de operacao transacional.
    /// </summary>
