...
/// PT-br: Transporta a conexao e o nivel de isolamento usados quando uma transacao esta prestes a iniciar.
/// </summary>
    ...
    IsolationLevel isolationLevel)
{
    ...
    /// PT-br: Conexao que esta iniciando a transacao.
    /// </summary>
    public DbConnection Connection { get; } = connection;

    /// <summary>
    /// EN: Isolation level requested for the transaction.
    /// PT-br: Nivel de isolamento solicitado para a transacao.
    /// </summary>
