...
/// PT-br: Adiciona helpers de conveniencia para criar factories de conexao com interceptacao.
/// </summary>
public static class DbInterceptionConnectionFactoryExtensions
{
    ...
    /// PT-br: Cria uma factory de interceptacao a partir de um delegate de conexao e interceptors explicitos.
    /// </summary>
    ...
    /// <returns>EN: Interception connection factory. PT-br: Factory de conexao com interceptacao.</returns>
    ...
    /// PT-br: Cria uma factory de interceptacao a partir de um delegate de conexao e de uma instancia pronta de opcoes de interceptacao.
    /// </summary>
    /// <param name="connectionFactory">EN: Delegate that creates the inner connection. PT-br: Delegate que cria a conexao interna.</param>
    ...
    /// PT-br: Cria uma factory de interceptacao a partir de um delegate de conexao e opcoes de interceptacao.
    /// </summary>
    /// <param name="connectionFactory">EN: Delegate that creates the inner connection. PT-br: Delegate que cria a conexao interna.</param>
