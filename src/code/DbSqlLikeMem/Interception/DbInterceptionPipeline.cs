...
/// PT-br: Encapsula conexoes ADO.NET com o pipeline de interceptacao do DbSqlLikeMem.
/// </summary>
public static class DbInterceptionPipeline
{
    ...
    /// PT-br: Encapsula uma conexao para que interceptors observem e modifiquem seus comandos e ciclo de vida.
    /// </summary>
    ...
    /// PT-br: Encapsula uma conexao usando interceptors construidos a partir do objeto de opcoes informado.
    /// </summary>
    /// <param name="connection">EN: Connection to wrap. PT-br: Conexao a encapsular.</param>
    ...
    /// PT-br: Encapsula uma conexao usando opcoes de interceptacao configuradas inline.
    /// </summary>
    /// <param name="connection">EN: Connection to wrap. PT-br: Conexao a encapsular.</param>
