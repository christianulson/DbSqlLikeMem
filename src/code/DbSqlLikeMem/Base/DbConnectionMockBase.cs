...
/// PT-br: Conexão simulado em memória com suporte a tabelas, transações e latência simulada.
/// </summary>
    ...
    ) : DbConnection
{
    ...
    /// PT-br: Banco em memória associado a esta conexão.
    /// </summary>
    public DbMock Db { get; } = db;

    /// <summary>
    /// EN: Connection usage and performance metrics.
    /// PT-br: Métricas de uso e desempenho da conexão.
    /// </summary>
    ...
    /// PT-br: Habilita ou desabilita a captura de planos de execução nesta conexão delegando para o banco subjacente.
    /// </summary>
    ...
    /// PT-br: Controla se snapshots de linhas afetadas devem ser capturados para diagnóstico.
    /// </summary>
    ...
    /// PT-br: Ultimo trace de debug de query em runtime capturado para esta conexao.
    /// </summary>
    ...
    /// PT-br: Traces de debug de query em runtime capturados durante a ultima execucao de comando.
    /// </summary>
    ...
    /// PT-br: Último plano de execução gerado por esta conexão.
    /// </summary>
    ...
    /// PT-br: Planos de execução gerados durante a última execução de comando.
    /// </summary>
    ...
    /// PT-br: Habilita o modo automatico de compatibilidade de dialeto SQL para parsing e execucao nesta conexao.
    /// </summary>
    ...
    /// PT-br: Numero maximo de traces de debug em runtime retidos no historico da conexao.
    /// </summary>
    ...
    /// PT-br: Limpa o historico de traces de debug em runtime mantido por esta conexao.
    /// </summary>
    ...
    /// PT-br: Encapsula esta conexao mock com o pipeline de interceptacao ADO.NET.
    /// </summary>
    ...
    /// PT-br: Executa um comando SQL e retorna os traces de operadores em runtime capturados para os statements de leitura dessa execucao.
    /// </summary>
    /// <param name="sql">EN: SQL text to execute. PT-br: Texto SQL a executar.</param>
    /// <returns>EN: Captured runtime traces for the executed command. PT-br: Traces de runtime capturados para o comando executado.</returns>
    ...
    /// PT-br: Executa um comando SQL e retorna o trace de operadores em runtime capturado para a ultima query de leitura.
    /// </summary>
    /// <param name="sql">EN: SQL text to execute. PT-br: Texto SQL a executar.</param>
    /// <returns>EN: Captured runtime trace for the executed command. PT-br: Trace de runtime capturado para o comando executado.</returns>
    ...
    /// PT-br: Executa um comando SQL e retorna o trace de runtime formatado para a ultima query de leitura.
    /// </summary>
    /// <param name="sql">EN: SQL text to execute. PT-br: Texto SQL a executar.</param>
    /// <returns>EN: Formatted runtime trace. PT-br: Trace de runtime formatado.</returns>
    ...
    /// PT-br: Executa um comando SQL e retorna os traces de runtime formatados para todos os statements de leitura do lote.
    /// </summary>
    /// <param name="sql">EN: SQL text to execute. PT-br: Texto SQL a executar.</param>
    /// <returns>EN: Formatted runtime trace batch. PT-br: Lote formatado de traces de runtime.</returns>
    ...
    /// PT-br: Executa um comando SQL e retorna o trace de runtime da ultima query de leitura como JSON estruturado.
    /// </summary>
    /// <param name="sql">EN: SQL text to execute. PT-br: Texto SQL a executar.</param>
    /// <returns>EN: JSON runtime trace. PT-br: Trace de runtime em JSON.</returns>
    ...
    /// PT-br: Executa um comando SQL e retorna os traces de runtime de todos os statements de leitura do lote como JSON estruturado.
    /// </summary>
    /// <param name="sql">EN: SQL text to execute. PT-br: Texto SQL a executar.</param>
    /// <returns>EN: JSON runtime trace batch. PT-br: Lote de traces de runtime em JSON.</returns>
    ...
    /// PT-br: Retorna um snapshot dos traces de debug em runtime atualmente retidos sem executar novo SQL.
    /// </summary>
    /// <returns>EN: Snapshot of the retained runtime traces. PT-br: Snapshot dos traces de runtime retidos.</returns>
    ...
    /// PT-br: Retorna os traces de debug em runtime atualmente retidos formatados como texto sem executar novo SQL.
    /// </summary>
    /// <returns>EN: Formatted runtime trace snapshot. PT-br: Snapshot formatado dos traces de runtime.</returns>
    ...
    /// PT-br: Retorna os traces de debug em runtime atualmente retidos como JSON sem executar novo SQL.
    /// </summary>
    /// <returns>EN: JSON runtime trace snapshot. PT-br: Snapshot JSON dos traces de runtime.</returns>
    ...
    /// PT-br: Retorna o ultimo trace de debug em runtime retido sem executar novo SQL.
    /// </summary>
    /// <returns>EN: Last retained runtime trace, when available. PT-br: Ultimo trace de runtime retido, quando disponivel.</returns>
    ...
    /// PT-br: Tenta obter o ultimo trace de debug em runtime retido sem lancar excecao quando nenhum estiver disponivel.
    /// </summary>
    /// <param name="trace">EN: Last retained trace when available; otherwise null. PT-br: Ultimo trace retido quando disponivel; caso contrario, null.</param>
    /// <returns>EN: True when a retained trace exists; otherwise false. PT-br: True quando existe um trace retido; caso contrario, false.</returns>
    ...
    /// PT-br: Retorna o ultimo trace de debug em runtime retido formatado como texto sem executar novo SQL.
    /// </summary>
    /// <returns>EN: Formatted last runtime trace. PT-br: Ultimo trace de runtime formatado.</returns>
    ...
    /// PT-br: Retorna o ultimo trace de debug em runtime retido como JSON sem executar novo SQL.
    /// </summary>
    /// <returns>EN: JSON payload for the last runtime trace. PT-br: Payload JSON do ultimo trace de runtime.</returns>
    ...
    /// PT-br: Exporta o snapshot estrutural atual do banco associado a esta conexao.
    /// </summary>
    /// <returns>EN: Exported schema snapshot. PT-br: Snapshot de schema exportado.</returns>
    ...
    /// PT-br: Exporta o snapshot estrutural atual do banco associado a esta conexao como JSON.
    /// </summary>
    /// <returns>EN: Serialized schema snapshot JSON. PT-br: JSON serializado do snapshot de schema.</returns>
    ...
    /// PT-br: Retorna o perfil do subset suportado de schema snapshot para o banco desta conexao.
    /// </summary>
    /// <returns>EN: Supported schema snapshot profile. PT-br: Perfil suportado de schema snapshot.</returns>
    ...
    /// PT-br: Retorna o perfil do subset suportado de schema snapshot para o banco desta conexao como texto.
    /// </summary>
    ...
    /// PT-br: Exporta o snapshot estrutural atual do banco associado a esta conexao para um arquivo JSON.
    /// </summary>
    ...
    /// PT-br: Importa um JSON de snapshot estrutural de schema para o banco associado a esta conexao.
    /// </summary>
    ...
    /// PT-br: Importa um JSON de snapshot estrutural de schema para o banco associado a esta conexao com validacao opcional de compatibilidade.
    /// </summary>
    /// <param name="json">EN: Serialized schema snapshot. PT-br: Snapshot de schema serializado.</param>
    ...
    /// PT-br: Importa um arquivo JSON de snapshot estrutural de schema para o banco associado a esta conexao.
    /// </summary>
    /// <param name="path">EN: Source JSON file path. PT-br: Caminho do arquivo JSON de origem.</param>
    ...
    /// PT-br: Importa um arquivo JSON de snapshot estrutural de schema para o banco associado a esta conexao com validacao opcional de compatibilidade.
    /// </summary>
    /// <param name="path">EN: Source JSON file path. PT-br: Caminho do arquivo JSON de origem.</param>
    /// <param name="ensureCompatibility">EN: True to enforce dialect/version compatibility before replay. PT-br: True para exigir compatibilidade de dialeto/versao antes do replay.</param>
    ...
    /// PT-br: Tempo limite de conexão simulada.
    /// </summary>
    ...
    /// PT-br: Nome do banco/schema atual.
    /// </summary>
    ...
    /// PT-br: Indica se existe transação ativa nesta conexão.
    /// </summary>
    public bool HasActiveTransaction => CurrentTransaction != null;

    /// <summary>
    /// EN: Active transaction isolation level for the current connection.
    /// PT-br: Nível de isolamento ativo da transação atual da conexão.
    /// </summary>
    ...
    /// PT-br: Cria e adiciona uma tabela temporária no escopo da conexão.
    /// </summary>
    ...
    /// PT-br: Tenta obter uma tabela temporária pelo nome.
    /// </summary>
    /// <param name="tableName">EN: Table name. PT-br: Nome da tabela.</param>
    ...
    /// PT-br: Cria e adiciona uma tabela ao banco.
    /// </summary>
    /// <param name="tableName">EN: Table name. PT-br: Nome da tabela.</param>
    /// <param name="columns">EN: Table columns. PT-br: Colunas da tabela.</param>
    /// <param name="rows">EN: Initial rows. PT-br: Linhas iniciais.</param>
    ...
    /// PT-br: Lista as tabelas do schema atual.
    /// </summary>
    /// <param name="schemaName">EN: Target schema. PT-br: Schema alvo.</param>
    /// <returns>EN: Table list. PT-br: Lista de tabelas.</returns>
    ...
    /// PT-br: Reseta todo o estado volátil em memória da conexão atual e do banco associado.
    /// </summary>
    ...
    /// PT-br: Registra um procedimento armazenado no schema atual do banco.
    /// </summary>
    /// <param name="procedure">EN: Procedure definition. PT-br: Definicao do procedimento.</param>
    /// <param name="schemaName">EN: Target schema. PT-br: Schema alvo.</param>
    ...
    /// PT-br: Registra um procedimento armazenado.
    /// </summary>
    ...
    /// PT-br: Registra uma funcao definida pelo usuario no schema atual do banco.
    /// </summary>
    ...
    /// PT-br: Tenta obter um procedimento armazenado.
    /// </summary>
    ...
    /// PT-br: Substitui ou registra uma funcao definida pelo usuario no schema atual do banco.
    /// </summary>
    ...
    /// PT-br: Substitui ou registra um procedimento armazenado no schema atual do banco.
    /// </summary>
    /// <param name="procedureName">EN: Procedure name. PT-br: Nome da procedure.</param>
    /// <param name="procedure">EN: Procedure definition. PT-br: Definicao da procedure.</param>
    /// <param name="schemaName">EN: Target schema. PT-br: Schema alvo.</param>
    /// <param name="orReplace">EN: True to replace an existing definition. PT-br: True para substituir uma definicao existente.</param>
    ...
    /// PT-br: Cria e registra uma sequence.
    /// </summary>
    /// <param name="sequenceName">EN: Sequence name. PT-br: Nome da sequence.</param>
    ...
    /// PT-br: Tenta obter uma sequence.
    /// </summary>
    /// <param name="sequenceName">EN: Sequence name. PT-br: Nome da sequence.</param>
    ...
    /// PT-br: Inicia uma transação com o nível de isolamento especificado.
    /// </summary>
    /// <param name="isolationLevel">EN: Isolation level. PT-br: Nível de isolamento.</param>
    /// <returns>EN: Created transaction. PT-br: Transação criada.</returns>
    ...
    /// PT-br: Cria uma instância de transação específica do provedor.
    /// </summary>
    ...
    /// PT-br: Altera o database/schema atual da conexão.
    /// </summary>
    /// <param name="databaseName">EN: Database name. PT-br: Nome do database.</param>
    ...
    /// PT-br: Fecha a conexão simulada.
    /// </summary>
    ...
    /// PT-br: Cria um comando associado à transação atual.
    /// </summary>
    ...
    /// PT-br: Cria um comando específico do provedor atrelado a uma transação.
    /// </summary>
    ...
    /// PT-br: Confirma a transação atual, liberando backups.
    /// </summary>
    ...
    /// PT-br: Desfaz a transação atual restaurando o backup.
    /// </summary>
    ...
    /// PT-br: Cria um savepoint nomeado dentro da transação ativa.
    /// </summary>
    ...
    /// PT-br: Executa rollback para um savepoint nomeado dentro da transação ativa.
    /// </summary>
    /// <param name="savepointName">EN: Savepoint name. PT-br: Nome do savepoint.</param>
    ...
    /// PT-br: Libera um savepoint nomeado da transação ativa.
    /// </summary>
    /// <param name="savepointName">EN: Savepoint name. PT-br: Nome do savepoint.</param>
    ...
    /// PT-br: Cria uma nova excecao especifica do provedor.
    /// </summary>
    ...
    /// PT-br: Descarta a conexão e os recursos associados.
    /// </summary>
