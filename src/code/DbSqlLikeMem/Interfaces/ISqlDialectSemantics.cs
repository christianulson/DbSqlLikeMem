...
internal interface ISqlDialectSemantics
{
    ...
    /// PT-br: Retorna os nomes de funcoes temporais disponiveis no dialeto atual.
    /// </summary>
    ...
    /// PT-br: Retorna os identificadores de funcoes temporais disponiveis no dialeto atual.
    /// </summary>
    ...
    /// PT-br: Retorna os nomes de chamada de funcoes temporais disponiveis no dialeto atual.
    /// </summary>
    ...
    /// PT-br: Indica se expressoes regulares invalidas avaliam como false.
    /// </summary>
    bool RegexInvalidPatternEvaluatesToFalse { get; }
    /// <summary>
    /// EN: Indicates whether regex matching is case insensitive by default.
    /// PT-br: Indica se a correspondencia de regex e case insensitive por padrao.
    /// </summary>
    bool RegexIsCaseInsensitive { get; }
    /// <summary>
    /// EN: Checks whether two UNION column types are compatible.
    /// PT-br: Verifica se dois tipos de coluna de UNION sao compativeis.
    /// </summary>
    ...
    /// PT-br: Verifica se um nome de tipo mapeia para um alvo de cast inteiro.
    /// </summary>
