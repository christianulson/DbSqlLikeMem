...
/// PT: Expõe verificações de capacidade de DDL e sequence para um dialeto SQL.
/// </summary>
internal interface ISqlDialectDdl
{
    ...
    /// PT: Indica se DDL de trigger e suportado.
    /// </summary>
    bool SupportsTriggers { get; }
    /// <summary>
    /// EN: Indicates whether sequence DDL is supported.
    /// PT: Indica se DDL de sequence e suportado.
    /// </summary>
    ...
    /// PT: Indica se DDL de function e suportado.
    /// </summary>
    bool SupportsFunctionDdl { get; }
    /// <summary>
    /// EN: Indicates whether CREATE OR REPLACE FUNCTION DDL is supported.
    /// PT: Indica se DDL CREATE OR REPLACE FUNCTION e suportado.
    /// </summary>
    ...
    /// PT: Indica se ALTER TABLE ADD COLUMN e suportado pelo dialeto atual.
    /// </summary>
