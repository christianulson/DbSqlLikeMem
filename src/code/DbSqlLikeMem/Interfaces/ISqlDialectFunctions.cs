...
/// PT-br: Expõe a resolucao de funcoes escalares, com retorno em tabela, de janela e temporais de um dialeto SQL.
/// </summary>
internal interface ISqlDialectFunctions
{
    /// <summary>
    /// EN: Resolves a scalar function definition by name.
    /// PT-br: Resolve uma definicao de funcao escalar pelo nome.
    /// </summary>
    ...
    /// PT-br: Resolve uma definicao de funcao escalar a partir de uma chamada analisada.
    /// </summary>
    ...
    /// PT-br: Resolve uma definicao de funcao escalar a partir de uma expressao de chamada legada.
    /// </summary>
    ...
    /// PT-br: Obtém a definicao de funcao agregada registrada para o nome informado.
    /// </summary>
    ...
    /// PT-br: Resolve uma definicao de funcao com retorno em tabela pelo nome.
    /// </summary>
    ...
    /// PT-br: Resolve uma definicao de funcao com retorno em tabela a partir de uma chamada analisada.
    /// </summary>
    ...
    /// PT-br: Resolve uma definicao de funcao de janela pelo nome.
    /// </summary>
    ...
    /// PT-br: Resolve uma definicao de funcao de janela a partir de uma expressao de janela analisada.
    /// </summary>
    ...
    /// PT-br: Resolve o tipo de funcao temporal associado a um nome de funcao.
    /// </summary>
    ...
    /// PT-br: Indica se o dialeto aceita um identificador temporal com o nome informado.
    /// </summary>
    ...
    /// PT-br: Indica se o dialeto aceita uma chamada temporal com o nome informado.
    /// </summary>
