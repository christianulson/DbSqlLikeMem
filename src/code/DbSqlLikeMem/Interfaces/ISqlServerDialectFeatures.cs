...
/// PT-br: Expõe suporte especifico de SQL Server para hints e funcoes de metadados em um dialeto SQL.
/// </summary>
internal interface ISqlServerDialectFeatures
{
    /// <summary>
    /// EN: Indicates whether SQL Server table hints are supported.
    /// PT-br: Indica se hints de tabela do SQL Server sao suportados.
    /// </summary>
    bool SupportsSqlServerTableHints { get; }
    /// <summary>
    /// EN: Indicates whether SQL Server query hints are supported.
    /// PT-br: Indica se hints de consulta do SQL Server sao suportados.
    /// </summary>
    ...
    /// PT-br: Indica se uma funcao de metadados do SQL Server e suportada pelo dialeto/versao atual.
    /// </summary>
    ...
    /// PT-br: Indica se um identificador de metadados do SQL Server e suportado pelo dialeto/versao atual.
    /// </summary>
    ...
    /// PT-br: Indica se uma funcao escalar do SQL Server e suportada pelo dialeto/versao atual.
    /// </summary>
    ...
    /// PT-br: Indica se uma funcao de data do SQL Server e suportada pelo dialeto/versao atual.
    /// </summary>
    ...
    /// PT-br: Indica se uma funcao agregada do SQL Server e suportada pelo dialeto/versao atual.
    /// </summary>
