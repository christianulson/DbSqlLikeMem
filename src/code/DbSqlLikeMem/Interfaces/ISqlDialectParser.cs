...
/// PT: Expõe regras de parser para identificadores, strings, palavras-chave e varredura de tokens.
/// </summary>
internal interface ISqlDialectParser
{
    /// <summary>
    /// EN: Indicates whether backtick-delimited identifiers are accepted.
    /// PT: Indica se identificadores delimitados por backtick sao aceitos.
    /// </summary>
    ...
    /// PT: Obtém os pares de aspas de identificador reconhecidos pelo dialeto.
    /// </summary>
    IReadOnlyList<SqlQuotePair> IdentifierQuotes { get; }
    /// <summary>
    /// EN: Gets the string quote pairs recognized by the dialect.
    /// PT: Obtém os pares de aspas de string reconhecidos pelo dialeto.
    /// </summary>
    ...
    /// PT: Indica se o dialeto aceita identificadores amigaveis ao parser compartilhados entre providers.
    /// </summary>
    ...
    /// PT: Indica se o dialeto aceita operadores JSON amigaveis ao parser compartilhados entre providers.
    /// </summary>
