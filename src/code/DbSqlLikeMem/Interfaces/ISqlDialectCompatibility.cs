...
/// PT: Expõe sintaxe de sequence, compatibilidade de parser, table hints e suporte a nomes auxiliares para um dialeto SQL.
/// </summary>
internal interface ISqlDialectCompatibility
{
    ...
    /// PT: Indica se a compatibilidade do sufixo de upsert em INSERT ... SELECT no parser esta habilitada.
    /// </summary>
    ...
    /// PT: Indica se a compatibilidade de DELETE sem FROM esta habilitada no parser.
    /// </summary>
    ...
    /// PT: Indica se a compatibilidade LIMIT/OFFSET esta habilitada no parser.
    /// </summary>
    ...
    /// PT: Mapeia um token para um operador binario suportado pelo dialeto atual.
    /// </summary>
