...
/// PT-br: Fornece extensões de injeção de dependência para registrar instâncias de SqlServerDbMock.
/// </summary>
public static class ServiceCollectionSqlServerDbMockExtensions
{
    /// <summary>
    /// EN: Registers SqlServerDbMock as a singleton service.
    /// PT-br: Registra SqlServerDbMock como serviço singleton.
    /// </summary>
    ...
    /// <param name="version">EN: Optional dialect version for SqlServerDbMock. PT-br: Versão opcional de dialeto para o SqlServerDbMock.</param>
    ...
    /// PT-br: Registra SqlServerDbMock como serviço com escopo.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for SqlServerDbMock. PT-br: Versão opcional de dialeto para o SqlServerDbMock.</param>
    ...
    /// <summary>
    /// EN: Registers SqlServerDbMock as a transient service.
    /// PT-br: Registra SqlServerDbMock como serviço transient.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for SqlServerDbMock. PT-br: Versão opcional de dialeto para o SqlServerDbMock.</param>
    /// <returns>EN: The same service collection for chaining. PT-br: A mesma coleção de serviços para encadeamento.</returns>
    public static IServiceCollection AddSqlServerDbMockTransient(
        this IServiceCollection services,
        Action<SqlServerDbMock>? acRegister = null,
        int? version = null)
