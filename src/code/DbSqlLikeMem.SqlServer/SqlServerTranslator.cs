...
#pragma warning restore CA1859 // Use concrete types when possible for improved performance
    ...
    {
        var collector = new SqlServerTranslationParameterCollector();
...
#pragma warning disable CS8605 // Unboxing a possibly null value.
    ...
    protected override Expression VisitMethodCall(MethodCallExpression node)
    {
        ...
        // SqlFunctions: Contains | FreeText
...
#pragma warning restore CS8605 // Unboxing a possibly null value.
            ...
            case ConstantExpression constant:
                {
                    ...
                    if (valueType.IsGenericType && valueType.GetGenericTypeDefinition() == typeof(SqlServerQueryable<>))
                    {
                        var property = valueType.GetProperty(nameof(SqlServerQueryable<object>.TableName), BindingFlags.Instance | BindingFlags.Public);
    ...
    private sealed class SqlServerTranslationParameterCollector : ExpressionVisitor
    {
