...
/// PT-br: Fornece extensões de injeção de dependência para registrar instâncias de NpgsqlDbMock.
/// </summary>
public static class ServiceCollectionNpgsqlDbMockExtensions
{
    /// <summary>
    /// EN: Registers NpgsqlDbMock as a singleton service.
    /// PT-br: Registra NpgsqlDbMock como serviço singleton.
    /// </summary>
    ...
    /// <param name="version">EN: Optional dialect version for NpgsqlDbMock. PT-br: Versão opcional de dialeto para o NpgsqlDbMock.</param>
    ...
    /// PT-br: Registra NpgsqlDbMock como serviço com escopo.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for NpgsqlDbMock. PT-br: Versão opcional de dialeto para o NpgsqlDbMock.</param>
    ...
    /// PT-br: Registra NpgsqlDbMock como serviço transient.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for NpgsqlDbMock. PT-br: Versão opcional de dialeto para o NpgsqlDbMock.</param>
