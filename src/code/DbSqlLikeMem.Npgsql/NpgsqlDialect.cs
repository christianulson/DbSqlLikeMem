...
internal sealed class NpgsqlDialect : SqlDialectBase, ISqlDialect
{
    ...
    /// PT-br: Obtém se há suporte a dollar quoted strings.
    /// </summary>
    ...
    /// PT-br: Obtém se há suporte a limit offset.
    /// </summary>
    ...
    /// PT-br: Indica se IIF(...) é suportada por este dialeto.
    /// </summary>
    ...
    /// PT-br: Indica se funções de janela SQL são suportadas pela versão configurada do PostgreSQL.
    /// </summary>
    ...
    /// PT-br: Expoe metadados de aridade de funcoes de janela para funcoes analiticas especificas do PostgreSQL e ignora COUNT agregado.
    /// </summary>
    /// <param name="functionName">EN: Window function name. PT-br: Nome da funcao de janela.</param>
    /// <param name="minArgs">EN: Minimum accepted argument count. PT-br: Numero minimo de argumentos aceitos.</param>
    /// <param name="maxArgs">EN: Maximum accepted argument count. PT-br: Numero maximo de argumentos aceitos.</param>
    /// <returns>EN: True when the function exposes arity metadata. PT-br: True quando a funcao expoe metadados de aridade.</returns>
    ...
    /// PT-br: Obtém se há suporte a fetch first.
    /// </summary>
    ...
    /// PT-br: Obtém se há suporte a returning.
    /// </summary>
    ...
    /// PT-br: Obtém se há suporte a expressões de sequence com ponto.
    /// </summary>
    ...
    /// PT-br: Obtém se há suporte a json arrow operators.
    /// </summary>
    ...
    /// PT-br: Obtém ou define allows parser cross dialect json operators.
    /// </summary>
    ...
    /// PT-br: Obtém se há suporte a with materialized hint.
    /// </summary>
    ...
    /// PT-br: Obtém ou define concat returns null on null input.
    /// </summary>
