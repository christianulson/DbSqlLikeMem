...
/// PT-br: Cobre cenarios adicionais de comportamento do PostgreSQL sobre o mock Npgsql.
/// </summary>
public sealed class PostgreSqlAdditionalBehaviorCoverageTests(
    ITestOutputHelper helper
) : AdditionalBehaviorCoverageTestsBase<NpgsqlDbMock, NpgsqlConnectionMock>(helper)
{
    /// <inheritdoc />
