...
/// PT: Cria conexoes simuladas Firebird abertas para pontos de integracao com EF Core.
/// </summary>
public sealed class FirebirdEfCoreConnectionFactory : IDbSqlLikeMemEfCoreConnectionFactory
{
    ...
    /// PT: Cria uma fabrica de conexao Firebird para EF Core sem interceptacao adicional.
    /// </summary>
