...
/// <summary>
/// EN: Covers parser corpus cases for the MySql dialect.
/// PT-br: Cobre casos de corpus do parser para o dialeto MySql.
/// </summary>
...
", "WITH inside derived table + outer WHERE" };
    ...
    "LIMIT with count only"
        ...
        yield return new object[] { "DELETE users WHERE id = 1", "DELETE without FROM keyword (MySQL syntax)" };
