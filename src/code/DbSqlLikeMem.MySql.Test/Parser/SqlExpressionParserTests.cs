...
/// PT-br: Cobre o parsing de expressoes WHERE para o dialeto MySql.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// PT-br: Verifica se o MySQL mantém o operador pipe como OR lógico por padrao.
    /// </summary>
    [Theory]
    [Trait("Category", "Parser")]
    [MemberDataMySqlVersion]
    ...
    /// PT-br: Verifica se o MySQL troca o operador pipe para concatenacao de strings quando PIPES_AS_CONCAT esta habilitado.
    /// </summary>
    [Theory]
    [Trait("Category", "Parser")]
    [MemberDataMySqlVersion]
    ...
    /// PT-br: Verifica se o modo ANSI_QUOTES trata nomes entre aspas duplas como identificadores.
    /// </summary>
    [Theory]
    [Trait("Category", "Parser")]
    [MemberDataMySqlVersion]
