...
/// <summary>
/// EN: Covers schema-level backup and restore when table work runs in parallel on a thread-safe SQL Azure database.
/// PT-br: Cobre backup e restore em nivel de schema quando o trabalho das tabelas executa em paralelo em um banco SQL Azure thread-safe.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    public void BackupRestoreAndClear_ShouldWorkWithMultipleTables_WhenThreadSafe()
    {
        ...
        var schema = Assert.IsType<SqlAzureSchemaMock>(db["DefaultSchema"]);
