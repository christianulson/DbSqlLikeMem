...
/// PT-br: Executa os testes compartilhados de CsvLoader e índices usando a implementação simulada de SQL Azure.
/// </summary>
/// <param name="helper">
    ...
    ) : CsvLoaderAndIndexTestBase<SqlAzureDbMock, SqlAzureMockException>(helper)
{
    ...
    /// PT-br: Cria um novo banco simulado de SQL Azure para cada execução de teste.
    /// </summary>
