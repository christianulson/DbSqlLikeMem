...
/// PT-br: Executa testes compartilhados de alertas de plano de execução para SQL Azure.
/// </summary>
    ...
    : ExecutionPlanPlanWarningsTestsBase(helper)
{
    ...
    /// PT-br: Cria uma conexão mock SQL Azure para cenários de teste de alertas.
    /// </summary>
