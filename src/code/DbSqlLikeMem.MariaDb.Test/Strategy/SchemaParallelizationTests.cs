...
/// <summary>
/// EN: Covers schema-level backup and restore when table work runs in parallel on a thread-safe MariaDB database.
/// PT-br: Cobre backup e restore em nivel de schema quando o trabalho das tabelas executa em paralelo em um banco MariaDB thread-safe.
/// </summary>
