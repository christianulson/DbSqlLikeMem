...
/// <summary>
/// EN: Runs MariaDB fidelity tests for MATCH ... AGAINST full-text search semantics.
/// PT-br: Executa testes de fidelidade MariaDB para a semantica de busca em texto completo MATCH ... AGAINST.
/// </summary>
public sealed class TextSearchTests : XUnitTestBase
{
    /// <summary>
    /// EN: Creates the MariaDB mock connection used by this test suite.
    /// PT-br: Cria a conexao mock MariaDB usada por esta suite de testes.
    /// </summary>
    ...
    private static MariaDbConnectionMock CreateOpenConnection()
    {
        ...
        var cnn = new MariaDbConnectionMock(db);
        cnn.Open();
