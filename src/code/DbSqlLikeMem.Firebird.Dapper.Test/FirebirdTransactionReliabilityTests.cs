...
/// PT-br: Valida as adicoes de confiabilidade transacional para cenarios Firebird.
/// </summary>
    ...
    ) : ProviderDapperTransactionReliabilityTestsBase<FirebirdDbMock, FirebirdConnectionMock>(helper)
{
    ...
    /// PT-br: Garante que rollback para savepoint restaure o estado intermediario.
    /// </summary>
    [Fact]
    ...
    /// PT-br: Garante que o modelo simplificado de isolamento seja deterministico e visivel.
    /// </summary>
    [Fact]
    [Trait("Category", "FirebirdTransactionReliability")]
    ...
    /// PT-br: Garante que commit e rollback concorrentes mantenham apenas gravacoes confirmadas entre versoes do provedor.
    /// </summary>
    /// <param name="version">EN: Provider version under test. PT-br: Versao do provedor em teste.</param>
    [Theory]
    [Trait("Category", "FirebirdTransactionReliability")]
    ...
    /// PT-br: Garante que commits concorrentes persistam gravacoes combinadas de forma deterministica entre versoes do provedor.
    /// </summary>
    /// <param name="version">EN: Provider version under test. PT-br: Versao do provedor em teste.</param>
    [Theory]
    [Trait("Category", "FirebirdTransactionReliability")]
    ...
    /// PT-br: Retorna as versoes do Firebird suportadas pelos cenarios de confiabilidade transacional.
    /// </summary>
