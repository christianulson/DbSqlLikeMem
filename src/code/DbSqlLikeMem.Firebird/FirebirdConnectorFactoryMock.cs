...
/// PT: Representa o tipo de fabrica de conectores Firebird simulado usado pelos mocks do provedor.
/// </summary>
public sealed class FirebirdConnectorFactoryMock : DbProviderFactory
{
    ...
    /// PT: Cria uma nova instancia de construtor de string de conexao.
    /// </summary>
    ...
    /// PT: Cria uma nova instancia de parametro.
    /// </summary>
    ...
    /// PT: Cria uma nova instancia de adaptador de dados.
    /// </summary>
    ...
    /// PT: Cria uma nova instancia de fonte de dados.
    /// </summary>
