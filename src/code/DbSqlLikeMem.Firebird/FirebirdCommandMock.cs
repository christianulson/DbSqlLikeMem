...
/// </summary>
public class FirebirdCommandMock(
    FirebirdConnectionMock? connection,
    FirebirdTransactionMock? transaction = null
    ) : DbCommand
{
    /// <summary>
    ...
    {
        get => transaction!;
        set => transaction = value as FirebirdTransactionMock;
    }
    ...
    protected override DbDataReader ExecuteDbDataReader(CommandBehavior behavior)
    {
        ...
        if (connection.TryHandleExecuteReaderPrelude(
            ...
            CommandText,
            Parameters,
            static () => new FirebirdDataReaderMock([[]]),
        ...
        return new FirebirdDataReaderMock(tables);
    }
    ...
    /// PT-br: Rejeita parametros GUID para corresponder ao comportamento do provedor Firebird usado nos caminhos de execucao de stored procedure.
    /// </summary>
