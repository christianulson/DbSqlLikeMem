...
/// PT-br: Registra o executor AST de Firebird na factory compartilhada.
/// </summary>
public static class FirebirdAstQueryExecutorRegister
{
    /// <summary>
    /// EN: Registers the Firebird AST executor for the Firebird dialect.
    /// PT-br: Registra o executor AST de Firebird para o dialeto Firebird.
    /// </summary>
...
/// PT-br: Wrapper de executor Firebird que reutiliza a base compartilhada de executor AST.
/// </summary>
