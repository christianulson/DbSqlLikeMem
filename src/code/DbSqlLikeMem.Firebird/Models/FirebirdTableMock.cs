...
/// PT-br: Tabela simulada em memória configurada para Firebird.
/// </summary>
...
) : TableMock(tableName, schema, columns, rows)
{
    ...
    /// PT-br: Obtém ou define o nome da coluna que está sendo resolvida pelos auxiliares de valor do Firebird.
    /// </summary>
    ...
    /// PT-br: Resolve um token SQL para um valor tipado usando regras de conversão do Firebird.
    /// </summary>
