...
/// PT: Representa um simulado de lote Firebird que executa comandos no banco em memória.
/// </summary>
public sealed class FirebirdBatchMock : DbBatch
{
    ...
    /// PT: Inicializa um simulado de lote Firebird com uma coleção de comandos vazia.
    /// </summary>
    ...
    /// PT: Inicializa um simulado de lote Firebird vinculado a uma conexão e a uma transação opcional.
    /// </summary>
...
/// PT: Representa uma entrada de comando executada por FirebirdBatchMock.
/// </summary>
...
/// PT: Representa a coleção que armazena os comandos executados por FirebirdBatchMock.
/// </summary>
