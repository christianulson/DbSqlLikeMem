...
/// PT-br: Representa o tipo Sql Azure Connector Factory simulado usado pelos mocks do provedor.
/// </summary>
    ...
    : DbProviderFactory
{
    ...
    /// PT-br: Cria uma instancia de fabrica simulada do provedor SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria uma instancia de comando simulado do SQL Azure.
    /// </summary>
    public override DbCommand CreateCommand() => new SqlAzureCommandMock();

    /// <summary>
    /// EN: Creates a SQL Azure connection mock instance.
    /// PT-br: Cria uma instancia de conexao simulada do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria um construtor generico de string de conexao para cenarios de provedor.
    /// </summary>
    public override DbConnectionStringBuilder CreateConnectionStringBuilder() => [];

    /// <summary>
    /// EN: Creates a provider parameter instance compatible with SQL Azure mocks.
    /// PT-br: Cria uma instancia de parametro de provedor compativel com mocks de SQL Azure.
    /// </summary>
    ...
    /// PT-br: Indica se esta fabrica de provedor pode criar instancias de adaptador de dados.
    /// </summary>
    ...
    /// PT-br: Cria uma instancia de adaptador de dados simulado do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Indica se esta fabrica de provedor pode criar um enumerador de fontes de dados.
    /// </summary>
    ...
    /// PT-br: Indica se esta fabrica de provedor pode criar objetos de lote.
    /// </summary>
    public override bool CanCreateBatch => true;

    /// <summary>
    /// EN: Creates a SQL Azure batch mock instance.
    /// PT-br: Cria uma instancia de lote simulado do SQL Azure.
    /// </summary>
    public override DbBatch CreateBatch() => new SqlAzureBatchMock();

    /// <summary>
    /// EN: Creates a SQL Azure batch command mock instance.
    /// PT-br: Cria uma instancia de comando de lote simulado do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria uma fonte de dados simulada do SQL Azure para a string de conexao informada.
    /// </summary>
