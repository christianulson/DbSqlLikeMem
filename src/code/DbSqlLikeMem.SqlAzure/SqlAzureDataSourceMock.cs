...
/// PT-br: Representa a fonte de dados simulada do SQL Azure usada pelos mocks do provedor.
/// </summary>
...
#endif
{
    ...
    /// PT-br: Obtem a string de conexao exposta por esta fonte de dados simulada do SQL Azure.
    /// </summary>
    public
#if NET7_0_OR_GREATER
    override
    ...
    /// PT-br: Cria uma instancia de conexao de banco para esta fonte de dados simulada do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria uma conexao tipada do SQL Azure para esta fonte de dados simulada do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria uma conexao tipada do SQL Azure a partir desta fonte de dados simulada.
    /// </summary>
    public
#if NET7_0_OR_GREATER
    new
