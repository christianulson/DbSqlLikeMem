...
/// PT-br: Tabela simulada especializada para operações de esquema no SQL Azure.
/// </summary>
    ...
    ) : SqlServerTableMock(tableName, schema, columns, rows)
{
    ...
    /// PT-br: Cria a excecao de coluna desconhecida do SQL Azure para acesso de coluna invalida.
    /// </summary>
    ...
    /// PT-br: Cria a excecao de chave duplicada do SQL Azure para violacoes de chave unica.
    /// </summary>
    ...
    /// PT-br: Cria a excecao do SQL Azure para valores nulos em colunas nao anulaveis.
    /// </summary>
    ...
    /// PT-br: Cria a excecao de falha de chave estrangeira do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria a excecao de linha referenciada do SQL Azure para restricoes de exclusao/atualizacao.
    /// </summary>
