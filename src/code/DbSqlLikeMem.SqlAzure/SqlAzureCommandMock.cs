    ...
    ) : SqlServerCommandMock(connection, transaction, suppressNoCountNormalization)
{
    ...
    /// PT-br: Cria um comando simulado vazio do SQL Azure sem conexao e sem transacao.
    /// </summary>
    ...
    /// PT-br: Obtem a colecao de parametros usada por este comando simulado do SQL Azure.
    /// </summary>
