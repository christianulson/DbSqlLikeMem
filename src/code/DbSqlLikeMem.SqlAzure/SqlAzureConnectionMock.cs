...
public class SqlAzureConnectionMock : SqlServerConnectionMock
{
    ...
    /// PT-br: Cria uma conexao simulada do SQL Azure com banco em memoria opcional e nome de banco padrao.
    /// </summary>
    ...
    /// PT-br: Cria uma instancia de transacao vinculada a esta conexao simulada do SQL Azure.
    /// </summary>
    ...
    /// PT-br: Cria a instancia principal de comando SQL Azure para esta conexao e transacao opcional.
    /// </summary>
    ...
    /// PT-br: Cria a excecao simulada especifica do SQL Azure usada por esta conexao.
    /// </summary>
