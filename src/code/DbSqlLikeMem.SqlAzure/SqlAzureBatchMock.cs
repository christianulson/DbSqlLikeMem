...
/// PT-br: Representa o tipo Sql Azure lote simulado usado pelos mocks do provedor.
/// </summary>
public sealed class SqlAzureBatchMock : DbBatch
{
    ...
    /// PT-br: Cria um lote simulado do SQL Azure vazio com colecao de comandos vazia.
    /// </summary>
    public SqlAzureBatchMock() => BatchCommands = [];

    /// <summary>
    /// EN: Creates a SQL Azure batch mock bound to a connection and optional transaction.
    /// PT-br: Cria um lote simulado do SQL Azure associado a uma conexao e transacao opcional.
    /// </summary>
    ...
    /// PT-br: Obtem ou define a conexao tipada do SQL Azure usada por este lote.
    /// </summary>
    ...
    /// PT-br: Obtem ou define a conexao de banco base usada por este lote.
    /// </summary>
    ...
    /// PT-br: Obtem ou define a transacao tipada usada por este lote.
    /// </summary>
    ...
    /// PT-br: Obtem ou define a transacao base usada por este lote.
    /// </summary>
    ...
    /// PT-br: Obtem ou define o timeout de comando aplicado aos comandos do lote.
    /// </summary>
    public override int Timeout { get; set; }

    /// <summary>
    /// EN: Gets the typed command collection held by this batch.
    /// PT-br: Obtem a colecao tipada de comandos mantida por este lote.
    /// </summary>
    ...
    /// PT-br: Obtem a colecao base de comandos em lote para consumo do framework.
    /// </summary>
    protected override DbBatchCommandCollection DbBatchCommands => BatchCommands;

    /// <summary>
    /// EN: Cancels the current batch by rolling back the active transaction when available.
    /// PT-br: Cancela o lote atual fazendo rollback da transacao ativa quando disponivel.
    /// </summary>
    ...
    /// PT-br: Executa todos os comandos do lote como operacoes sem consulta e retorna o total de linhas afetadas.
    /// </summary>
    ...
    /// PT-br: Executa todos os comandos do lote e retorna um data reader combinado para os conjuntos de resultados.
    /// </summary>
    ...
    /// PT-br: Executa assincronamente todos os comandos do lote como operacoes sem consulta.
    /// </summary>
    ...
    /// PT-br: Executa assincronamente todos os comandos do lote e retorna um data reader combinado.
    /// </summary>
...
;
    ...
    /// PT-br: Executa assincronamente o primeiro comando do lote e retorna seu resultado escalar.
    /// </summary>
    ...
    /// PT-br: Prepara assincronamente o lote para execucao.
    /// </summary>
    ...
    /// PT-br: Prepara o lote para execucao.
    /// </summary>
    public override void Prepare() { }

    /// <summary>
    /// EN: Creates a new typed SQL Azure batch command instance.
    /// PT-br: Cria uma nova instancia tipada de comando em lote do SQL Azure.
    /// </summary>
...
/// PT-br: Representa o tipo Sql Azure comando em lote simulado usado pelos mocks do provedor.
/// </summary>
public sealed class SqlAzureBatchCommandMock : DbBatchCommand
{
    ...
    /// PT-br: Obtem ou define o texto SQL executado por este comando em lote.
    /// </summary>
    public override string CommandText { get; set; } = string.Empty;
    /// <summary>
    /// EN: Gets or sets the command type used by this batch command.
    /// PT-br: Obtem ou define o tipo de comando usado por este comando em lote.
    /// </summary>
    public override CommandType CommandType { get; set; } = CommandType.Text;
    /// <summary>
    /// EN: Gets the number of records affected by the command execution.
    /// PT-br: Obtem o numero de registros afetados pela execucao do comando.
    /// </summary>
    public override int RecordsAffected => recordsAffected;
    /// <summary>
    /// EN: Gets the parameter collection associated with this batch command.
    /// PT-br: Obtem a colecao de parametros associada a este comando em lote.
    /// </summary>
...
/// PT-br: Representa o tipo Sql Azure coleção de comandos de lote simulado usado pelos mocks do provedor.
/// </summary>
public sealed class SqlAzureBatchCommandCollectionMock : DbBatchCommandCollection
{
    ...
    /// PT-br: Obtem o numero de comandos atualmente armazenados na colecao.
    /// </summary>
    public override int Count => Commands.Count;
    /// <summary>
    /// EN: Gets whether the collection is read-only.
    /// PT-br: Obtem se a colecao e somente leitura.
    /// </summary>
    public override bool IsReadOnly => false;

    /// <summary>
    /// EN: Adds a batch command to the collection when it is SQL Azure compatible.
    /// PT-br: Adiciona um comando em lote a colecao quando ele e compativel com SQL Azure.
    /// </summary>
    ...
    /// PT-br: Copia os comandos da colecao para um array a partir do indice de destino.
    /// </summary>
    ...
    /// PT-br: Retorna um enumerador para iterar pelos comandos da colecao.
    /// </summary>
    ...
    /// PT-br: Retorna o indice do comando especificado na colecao.
    /// </summary>
    ...
    /// PT-br: Insere um comando na colecao no indice especificado.
    /// </summary>
    ...
    /// PT-br: Remove o comando especificado da colecao.
    /// </summary>
    ...
    /// PT-br: Substitui o comando no indice especificado por uma nova instancia de comando.
    /// </summary>
