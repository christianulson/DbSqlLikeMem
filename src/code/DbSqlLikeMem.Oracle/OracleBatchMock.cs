...
/// PT-br: Representa um simulado de lote Oracle que executa comandos no banco em memória.
/// </summary>
public sealed class OracleBatchMock : DbBatch
{
    ...
    /// PT-br: Inicializa um simulado de lote Oracle com uma coleção de comandos vazia.
    /// </summary>
    ...
    /// PT-br: Inicializa um simulado de lote Oracle vinculado a uma conexão e a uma transação opcional.
    /// </summary>
    ...
    /// PT-br: Cria uma nova instância de simulado de comando em lote Oracle.
    /// </summary>
...
/// PT-br: Representa uma entrada de comando executada por OracleBatchMock.
/// </summary>
...
/// PT-br: Representa a coleção que armazena os comandos executados por OracleBatchMock.
/// </summary>
