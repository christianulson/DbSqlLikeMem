...
internal sealed class OracleDialect : SqlDialectBase, ISqlDialect
{
    ...
    /// PT-br: Obtém o modo de comparação de texto usado pelos fallbacks de igualdade e ordenacao de strings no Oracle.
    /// </summary>
    ...
    /// PT-br: Indica se comparacoes LIKE devem ignorar maiusculas e minusculas para a semantica Oracle configurada.
    /// </summary>
    ...
    /// PT-br: Indica se funções de janela SQL são suportadas pela versão configurada do Oracle.
    /// </summary>
    ...
    /// PT-br: Rejeita IIF(...) porque o Oracle SQL nao expõe isso como funcao escalar nativa.
    /// </summary>
    ...
    /// PT-br: Obtém se CROSS APPLY e OUTER APPLY são suportados.
    /// </summary>
    ...
    /// PT-br: Representa Is Integer Cast Type Name.
    /// </summary>
