...
/// PT-br: Fornece extensões de injeção de dependência para registrar instâncias de OracleDbMock.
/// </summary>
public static class ServiceCollectionOracleDbMockExtensions
{
    /// <summary>
    /// EN: Registers OracleDbMock as a singleton service.
    /// PT-br: Registra OracleDbMock como serviço singleton.
    /// </summary>
    ...
    /// <param name="version">EN: Optional dialect version for OracleDbMock. PT-br: Versão opcional de dialeto para o OracleDbMock.</param>
    ...
    /// PT-br: Registra OracleDbMock como serviço com escopo.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for OracleDbMock. PT-br: Versão opcional de dialeto para o OracleDbMock.</param>
    ...
    /// PT-br: Registra OracleDbMock como serviço transient.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for OracleDbMock. PT-br: Versão opcional de dialeto para o OracleDbMock.</param>
