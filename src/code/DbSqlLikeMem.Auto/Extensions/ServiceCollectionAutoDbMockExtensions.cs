...
/// PT: Fornece extensões de injeção de dependência para registrar instâncias de AutoDbMock.
/// </summary>
public static class ServiceCollectionAutoDbMockExtensions
{
    /// <summary>
    /// EN: Registers AutoDbMock as a singleton service.
    /// PT: Registra AutoDbMock como serviço singleton.
    /// </summary>
    ...
    /// <param name="version">EN: Optional dialect version for AutoDbMock. PT: Versão opcional de dialeto para o AutoDbMock.</param>
    ...
    /// PT: Registra AutoDbMock como serviço com escopo.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for AutoDbMock. PT: Versão opcional de dialeto para o AutoDbMock.</param>
    ...
    /// PT: Registra AutoDbMock como serviço transient.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for AutoDbMock. PT: Versão opcional de dialeto para o AutoDbMock.</param>
