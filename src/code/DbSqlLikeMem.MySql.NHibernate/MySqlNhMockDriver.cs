namespace DbSqlLikeMem.MySql.NHibernate;

/// <summary>
/// EN: NHibernate driver bound to DbSqlLikeMem MySql mock ADO.NET types.
/// PT-br: Driver NHibernate ligado aos tipos ADO.NET simulado MySql do DbSqlLikeMem.
/// </summary>
public sealed class MySqlNhMockDriver : ReflectionBasedDriver
{
    ...
    /// PT-br: Inicializa um driver simulado do NHibernate para os tipos do provedor MySql do DbSqlLikeMem.
    /// </summary>
