...
/// PT-br: Cria conexões simulado MySql abertas para pontos de integração com EF Core.
/// </summary>
public sealed class MySqlEfCoreConnectionFactory : IDbSqlLikeMemEfCoreConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao MySql para EF Core sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao MySql para EF Core que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao MySql para EF Core que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
