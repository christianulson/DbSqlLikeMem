...
/// PT-br: Driver NHibernate ligado aos tipos ADO.NET simulado Npgsql do DbSqlLikeMem.
/// </summary>
public sealed class NpgsqlNhMockDriver : ReflectionBasedDriver
{
    ...
    /// PT-br: Inicializa um driver simulado do NHibernate para os tipos do provedor Npgsql do DbSqlLikeMem.
    /// </summary>
