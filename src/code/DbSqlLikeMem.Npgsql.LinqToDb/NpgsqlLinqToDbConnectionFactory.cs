...
/// PT-br: Cria conexões simulado Npgsql abertas para pontos de integração com LinqToDB.
/// </summary>
public sealed class NpgsqlLinqToDbConnectionFactory : IDbSqlLikeMemLinqToDbConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Npgsql para LinqToDB sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Npgsql para LinqToDB que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Npgsql para LinqToDB que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
    ...
    /// PT-br: Cria e abre uma conexão simulada Npgsql apoiada por um banco em memória do DbSqlLikeMem.
    /// </summary>
