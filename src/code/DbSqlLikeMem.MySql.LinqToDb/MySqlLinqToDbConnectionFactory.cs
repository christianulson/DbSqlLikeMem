...
/// PT-br: Cria conexões simulado MySql abertas para pontos de integração com LinqToDB.
/// </summary>
public sealed class MySqlLinqToDbConnectionFactory : IDbSqlLikeMemLinqToDbConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao MySql para LinqToDB sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao MySql para LinqToDB que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao MySql para LinqToDB que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
    ...
    /// PT-br: Cria e abre uma conexão simulada MySql apoiada por um banco em memória do DbSqlLikeMem.
    /// </summary>
