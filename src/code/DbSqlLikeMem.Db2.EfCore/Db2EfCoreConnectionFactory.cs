...
/// PT-br: Cria conexões simulado Db2 abertas para pontos de integração com EF Core.
/// </summary>
public sealed class Db2EfCoreConnectionFactory : IDbSqlLikeMemEfCoreConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Db2 para EF Core sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Db2 para EF Core que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Db2 para EF Core que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
