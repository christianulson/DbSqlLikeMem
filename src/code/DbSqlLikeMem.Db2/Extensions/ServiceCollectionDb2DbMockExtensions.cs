...
/// PT-br: Fornece extensões de injeção de dependência para registrar instâncias de Db2DbMock.
/// </summary>
public static class ServiceCollectionDb2DbMockExtensions
{
    /// <summary>
    /// EN: Registers Db2DbMock as a singleton service.
    /// PT-br: Registra Db2DbMock como serviço singleton.
    /// </summary>
    ...
    /// <param name="version">EN: Optional dialect version for Db2DbMock. PT-br: Versão opcional de dialeto para o Db2DbMock.</param>
    ...
    /// PT-br: Registra Db2DbMock como serviço com escopo.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for Db2DbMock. PT-br: Versão opcional de dialeto para o Db2DbMock.</param>
    ...
    /// PT-br: Registra Db2DbMock como serviço transient.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for Db2DbMock. PT-br: Versão opcional de dialeto para o Db2DbMock.</param>
