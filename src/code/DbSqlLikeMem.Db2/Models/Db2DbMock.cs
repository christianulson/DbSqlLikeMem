...
/// PT-br: Banco de dados simulado em memória configurado para Db2.
/// </summary>
    ...
    : DbMock
{
    ...
    /// PT-br: Inicializa um banco Db2 simulado em memória com a versão informada.
    /// </summary>
    public Db2DbMock(
        int? version = null
        ) : base(version ?? 11)
    ...
    /// PT-br: Cria uma instância de simulado de schema DB2.
    /// </summary>
