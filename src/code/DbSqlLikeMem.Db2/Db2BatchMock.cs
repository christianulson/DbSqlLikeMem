...
/// PT-br: Representa o tipo Db2 lote simulado usado pelos mocks do provedor.
/// </summary>
public sealed class Db2BatchMock : DbBatch
{
    ...
    /// PT-br: Representa um simulado de lote específico do provedor que executa comandos no banco em memória.
    /// </summary>
    ...
    /// PT-br: Execute Non consulta para o estado atual do lote.
    /// </summary>
    public override int ExecuteNonQuery()
    {
        ...
        return Db2NonQueryResultHelper.NormalizeBatchResult(
    ...
    /// PT-br: Execute Db Data leitor para o estado atual do lote.
    /// </summary>
    ...
    /// PT-br: Execute Scalar para o estado atual do lote.
    /// </summary>
    ...
    /// PT-br: Execute Non consulta Async para o estado atual do lote.
    /// </summary>
    ...
    /// PT-br: Execute Db Data leitor Async para o estado atual do lote.
    /// </summary>
...
;
    ...
    /// PT-br: Execute Scalar Async para o estado atual do lote.
    /// </summary>
...
/// PT-br: Representa o tipo Db2 comando em lote simulado usado pelos mocks do provedor.
/// </summary>
public sealed class Db2BatchCommandMock : DbBatchCommand, IDb2CommandMock
{
    ...
    /// PT-br: Executa comando text.
    /// </summary>
    public override string CommandText { get; set; } = string.Empty;

    /// <summary>
    /// EN: Executes command type.
    /// PT-br: Executa comando type.
    /// </summary>
...
/// PT-br: Representa o tipo Db2 coleção de comandos de lote simulado usado pelos mocks do provedor.
/// </summary>
public sealed class Db2BatchCommandCollectionMock : DbBatchCommandCollection
{
    ...
    /// PT-br: Obtém is read only.
    /// </summary>
    public override bool IsReadOnly => false;

    /// <summary>
    /// EN: Add operation for batch commands.
    /// PT-br: Operação de add para comandos em lote.
    /// </summary>
    ...
    /// PT-br: Operação de clear para comandos em lote.
    /// </summary>
    public override void Clear() => Commands.Clear();

    /// <summary>
    /// EN: Contains operation for batch commands.
    /// PT-br: Operação de contains para comandos em lote.
    /// </summary>
    ...
    /// PT-br: Operação de copy to para comandos em lote.
    /// </summary>
    ...
    /// PT-br: Operação de index of para comandos em lote.
    /// </summary>
    ...
    /// PT-br: Operação de insert para comandos em lote.
    /// </summary>
    ...
    /// PT-br: Operação de remove para comandos em lote.
    /// </summary>
