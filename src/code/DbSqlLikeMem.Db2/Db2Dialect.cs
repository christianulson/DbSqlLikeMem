...
internal sealed class Db2Dialect : SqlDialectBase, ISqlDialect
{
    ...
    /// PT-br: Indica se funções de janela SQL são suportadas pela versão DB2 configurada.
    /// </summary>
    ...
    /// PT-br: Indica se cláusulas SQL de frame de janela são suportadas pela versão DB2 configurada.
    /// </summary>
    ...
    /// PT-br: Verifica se um helper agregado no estilo SQL Server e suportado pelo comportamento de compatibilidade DB2.
    /// </summary>
    ...
    /// PT-br: Obtém se CREATE OR REPLACE FUNCTION é suportado.
    /// </summary>
    ...
    /// PT-br: Obtém os nomes de funções de substituição de nulos suportados pelo comportamento de compatibilidade do DB2.
    /// </summary>
    ...
    /// PT-br: Obtém ou define allows parser limit offset compatibility.
    /// </summary>
