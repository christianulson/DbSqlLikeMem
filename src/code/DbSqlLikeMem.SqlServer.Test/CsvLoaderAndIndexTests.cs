...
/// PT-br: Executa os testes compartilhados de CsvLoader e índices usando a implementação simulado de SQL Server.
/// </summary>
/// <param name="helper">
    ...
    ) : CsvLoaderAndIndexTestBase<SqlServerDbMock, SqlServerMockException>(helper)
{
    ...
    /// PT-br: Cria um novo banco simulado de SQL Server para cada execução de teste.
    /// </summary>
