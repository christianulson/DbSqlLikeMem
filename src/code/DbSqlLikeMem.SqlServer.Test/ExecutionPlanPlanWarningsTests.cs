...
/// PT-br: Executa testes compartilhados de alertas de plano de execução para SQL Server.
/// </summary>
    ...
    : ExecutionPlanPlanWarningsTestsBase(helper)
{
    ...
    /// PT-br: Cria uma conexão mock SQL Server para cenários de teste de alertas.
    /// </summary>
    ...
    /// PT-br: Obtém consulta ORDER BY com TOP específica do provedor usada pelos testes compartilhados.
    /// </summary>
