...
/// <summary>
/// EN: Covers multi-row and select-based INSERT scenarios in the SqlServer mock.
/// PT-br: Cobre cenarios de INSERT com multiplas linhas e baseado em SELECT no mock SqlServer.
/// </summary>
    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// <summary>
    /// EN: Verifies that omitting an identity column lets SqlServer generate the value.
    /// PT-br: Verifica se omitir a coluna identity permite ao SqlServer gerar o valor.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
