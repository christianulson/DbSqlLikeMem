...
/// <summary>
/// EN: Covers subquery projection and nested join scenarios in the SqlServer mock.
/// PT-br: Cobre projecao de subquery e cenarios de join aninhado no mock SqlServer.
/// </summary>
