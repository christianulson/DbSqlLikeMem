...
/// PT-br: Executa os testes compartilhados de EXISTS/NOT EXISTS usando a conexão simulada de SQL Server.
/// </summary>
/// <param name="helper">
    ...
    ) : ExistsTestsBase(helper)
{
    ...
    /// PT-br: Cria uma conexão simulada de SQL Server usada pelos testes compartilhados de EXISTS.
    /// </summary>
