    ...
    ) : XUnitTestBase(helper)
{
    ...
    /// PT: Garante que liberar um savepoint sem uma transação ativa mantenha a mensagem acionável em runtime no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT: Garante que criar um savepoint sem uma transacao ativa mantenha a mensagem acionavel em runtime no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT: Garante que rollback para savepoint sem uma transacao ativa mantenha a mensagem acionavel em runtime no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT: Garante que liberar um savepoint desconhecido mantenha a mensagem acionavel em runtime no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT: Garante que criar um savepoint com nome em branco mantenha a mensagem de validacao de parametro no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT: Garante que executar rollback para um savepoint com nome em branco mantenha a mensagem de validacao de parametro no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
    ...
    /// PT: Garante que liberar um savepoint com nome em branco mantenha a mensagem de validacao de parametro no Npgsql.
    /// </summary>
    [Fact]
    [Trait("Category", "Strategy")]
