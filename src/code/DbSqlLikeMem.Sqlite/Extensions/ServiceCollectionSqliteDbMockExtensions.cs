...
/// PT-br: Fornece extensões de injeção de dependência para registrar instâncias de SqliteDbMock.
/// </summary>
public static class ServiceCollectionSqliteDbMockExtensions
{
    /// <summary>
    /// EN: Registers SqliteDbMock as a singleton service.
    /// PT-br: Registra SqliteDbMock como serviço singleton.
    /// </summary>
    ...
    /// <param name="version">EN: Optional dialect version for SqliteDbMock. PT-br: Versão opcional de dialeto para o SqliteDbMock.</param>
    ...
    /// PT-br: Registra SqliteDbMock como serviço com escopo.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for SqliteDbMock. PT-br: Versão opcional de dialeto para o SqliteDbMock.</param>
    ...
    /// PT-br: Registra SqliteDbMock como serviço transient.
    /// </summary>
    /// <param name="services">EN: Service collection to register into. PT-br: Coleção de serviços para registrar.</param>
    /// <param name="acRegister">EN: Optional callback to configure the created mock. PT-br: Callback opcional para configurar o mock criado.</param>
    /// <param name="version">EN: Optional dialect version for SqliteDbMock. PT-br: Versão opcional de dialeto para o SqliteDbMock.</param>
