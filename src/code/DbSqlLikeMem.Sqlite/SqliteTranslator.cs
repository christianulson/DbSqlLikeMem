...
#pragma warning restore CA1859 // Use concrete types when possible for improved performance
    ...
    {
        var collector = new SqliteTranslationParameterCollector();
...
#pragma warning restore CS8605 // Unboxing a possibly null value.
            ...
            case ConstantExpression constant:
                {
                    ...
                    if (valueType.IsGenericType && valueType.GetGenericTypeDefinition() == typeof(SqliteQueryable<>))
                    {
                        var property = valueType.GetProperty(nameof(SqliteQueryable<object>.TableName), BindingFlags.Instance | BindingFlags.Public);
    ...
    private sealed class SqliteTranslationParameterCollector : ExpressionVisitor
    {
