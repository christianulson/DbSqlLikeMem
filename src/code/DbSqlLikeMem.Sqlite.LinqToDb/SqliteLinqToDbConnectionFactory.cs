...
/// PT-br: Cria conexões simulado Sqlite abertas para pontos de integração com LinqToDB.
/// </summary>
public sealed class SqliteLinqToDbConnectionFactory : IDbSqlLikeMemLinqToDbConnectionFactory
{
    ...
    /// PT-br: Cria uma factory de conexao Sqlite para LinqToDB sem interceptacao adicional.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Sqlite para LinqToDB que encapsula cada conexao criada com interceptors explicitos.
    /// </summary>
    ...
    /// PT-br: Cria uma factory de conexao Sqlite para LinqToDB que encapsula cada conexao criada usando opcoes de interceptacao.
    /// </summary>
    ...
    /// PT-br: Cria e abre uma conexão simulada Sqlite apoiada por um banco em memória do DbSqlLikeMem.
    /// </summary>
