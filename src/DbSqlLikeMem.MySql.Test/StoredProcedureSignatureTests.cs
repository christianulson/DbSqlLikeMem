    ...
    ) : XUnitTestBase(helper)
{
    ...
    public void StoredProcedure_ShouldValidateRequiredInAndOutParams()
    {
        ...
        using var cmd = new MySqlCommandMock(c)
        {
            CommandType = CommandType.StoredProcedure,
            CommandText = "sp_demo"
        };
        cmd.Parameters.Add(new MySqlParameter { ParameterName = "tenantId", DbType = DbType.Int32, Value = 10 });
        cmd.Parameters.Add(new MySqlParameter { ParameterName = "resultCode", DbType = DbType.Int32, Direction = ParameterDirection.Output, Value = DBNull.Value });
