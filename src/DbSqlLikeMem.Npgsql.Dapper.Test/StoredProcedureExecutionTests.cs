    ...
    ) : XUnitTestBase(helper)
{
    ...
    private static NpgsqlParameter P(string name, object? value, DbType dbType, ParameterDirection dir = ParameterDirection.Input)
        => new()
        {
    ...
    public void ExecuteNonQuery_StoredProcedure_ShouldPopulateOutParameters_DefaultValue()
    {
        ...
        Assert.Equal(string.Empty, ((NpgsqlParameter)cmd.Parameters["@o_token"]).Value);
