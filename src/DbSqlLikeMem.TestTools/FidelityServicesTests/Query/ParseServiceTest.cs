...
/// PT: Executa helpers de benchmark no estilo parser sobre trechos SQL representativos.
/// </summary>
public static class ParseServiceTest
{
    /// <summary>
    /// EN: Counts the tokens produced by a simple SELECT statement.
    /// PT: Conta os tokens produzidos por uma instrução SELECT simples.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por uma instrução de junção complexa.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por uma instrução INSERT RETURNING.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por uma instrução ON CONFLICT DO UPDATE.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por uma instrução de extração JSON.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por uma instrução de agregacao de strings WITHIN GROUP.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por uma instrução de paginação auto-dialect.
    /// </summary>
    ...
    /// PT: Conta os tokens produzidos por um lote de multiplas instrucoes.
    /// </summary>
