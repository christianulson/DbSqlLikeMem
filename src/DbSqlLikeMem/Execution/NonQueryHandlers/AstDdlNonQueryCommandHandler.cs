...
internal sealed class AstDdlNonQueryCommandHandler : INonQueryCommandHandler
{
        ...
        out int affectedRows)
    {
        ...
        return query is SqlCreateTemporaryTableQuery or SqlCreateViewQuery or SqlCreateIndexQuery or SqlCreateSequenceQuery or SqlDropViewQuery or SqlDropTableQuery or SqlDropIndexQuery or SqlDropSequenceQuery;
    }
}
