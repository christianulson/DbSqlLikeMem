...
internal static class SqlServerFunctionSupportHelper
{
    ...
    private static readonly HashSet<string> _scalarFunctions = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "ISJSON", "ISNUMERIC", "CHAR", "CONCAT", "CONCAT_WS", "LEN", "LEFT", "LOG", "LOG10", "LOWER",
        "PI", "POWER", "RADIANS", "RAND", "NCHAR", "JSON_MODIFY", "NEWID", "NEWSEQUENTIALID", "REPLACE",
        "RIGHT", "ROUND", "SIGN", "SIN", "SQUARE", "STR", "SUBSTRING", "TAN", "STRING_ESCAPE",
