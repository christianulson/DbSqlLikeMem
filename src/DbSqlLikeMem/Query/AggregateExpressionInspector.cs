...
internal static class AggregateExpressionInspector
{
    ...
    private static readonly HashSet<string> AggregateFunctionNames = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "MEDIAN","PERCENTILE","PERCENTILE_CONT","PERCENTILE_DISC","VAR","VARP","VAR_POP","VAR_SAMP","VARIANCE",
        "COLLECT","CORR","CORR_K","CORR_S","COVAR_POP","COVAR_SAMP","CV","JSON_OBJECTAGG","GROUP_ID","CHECKSUM_AGG",
        ...
        "STDEV","STDEVP","STDDEV","STDDEV_POP","STDDEV_SAMP","STATS_BINOMIAL_TEST","STATS_CROSSTAB","STATS_F_TEST","STATS_KS_TEST","STATS_MODE","STATS_MW_TEST","STATS_ONE_WAY_ANOVA",
