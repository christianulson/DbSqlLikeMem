...
/// PT-br: Fornece o conjunto de benchmarks de sequence para suites de provedores que suportam sequence.
/// </summary>
public abstract class SequenceBenchmarkSuiteBase : BenchmarkSuiteBase
{
    /// <summary>
    /// EN: Executes a sequence next-value benchmark.
    /// PT-br: Executa um benchmark de proximo valor de sequencia.
    /// </summary>
    [Benchmark]
    ...
    /// PT-br: Executa um benchmark de valor atual de sequencia.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de round-trip de insert com sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de insert com expressao de sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de projecao select com sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de filtro com expressao de sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de matriz CASE/WHERE com sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de matriz temporal com sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
    ...
    /// PT-br: Executa um benchmark de join agregado com sequence.
    /// </summary>
    [Benchmark]
    [BenchmarkCategory("core")]
