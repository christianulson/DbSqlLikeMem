...
/// PT-br: Define a suite de benchmark DbSqlLikeMem para SQL Server.
/// </summary>
public class SqlServer_DbSqlLikeMem_Benchmarks : SequenceBenchmarkSuiteBase
{
    /// <summary>
    /// EN: Creates the benchmark session used by the SQL Server DbSqlLikeMem suite.
    /// PT-br: Cria a sessao de benchmark usada pela suite DbSqlLikeMem de SQL Server.
    /// </summary>
