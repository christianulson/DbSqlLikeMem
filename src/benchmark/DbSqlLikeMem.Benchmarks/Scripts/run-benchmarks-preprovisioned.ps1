...
$env:DBSQLLIKEMEM_BENCH_MARIADB_CONNECTION_STRING="Server=127.0.0.1;Port=13307;Database=benchmark;Uid=root;Pwd=root;Pooling=false;"
...
$env:DBSQLLIKEMEM_BENCH_FIREBIRD_CONNECTION_STRING="User=benchmark;Password=benchmark;Database=127.0.0.1/13050:/var/lib/firebird/data/benchmark.fdb;Dialect=3;Charset=UTF8;Pooling=false;"

# Backward-compatible aliases
$env:MYSQL_CONNECTION_STRING=$env:DBSQLLIKEMEM_BENCH_MYSQL_CONNECTION_STRING
$env:MARIADB_CONNECTION_STRING=$env:DBSQLLIKEMEM_BENCH_MARIADB_CONNECTION_STRING
...
$env:FIREBIRD_CONNECTION_STRING=$env:DBSQLLIKEMEM_BENCH_FIREBIRD_CONNECTION_STRING
